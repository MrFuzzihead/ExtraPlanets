...
public class ExtraPlanets_Armor {
    ...
    private static ArmorMaterial carbon_ArmorMaterial = EnumHelper
        .addArmorMaterial("Carbon_Armor", 26, new int[] { 3, 8, 6, 3 }, 15);
    private static ArmorMaterial palladium_ArmorMaterial = EnumHelper
        .addArmorMaterial("Palladium_Armor", 26, new int[] { 3, 8, 6, 3 }, 13);
    private static ArmorMaterial magnesium_ArmorMaterial = EnumHelper
        .addArmorMaterial("Magnesium_Armor", 30, new int[] { 3, 8, 6, 3 }, 11);
    private static ArmorMaterial crystal_ArmorMaterial = EnumHelper
        .addArmorMaterial("Crystal_Armor", 40, new int[] { 3, 8, 6, 3 }, 10);

    private static ArmorMaterial mercury_ArmorMaterial = EnumHelper
        .addArmorMaterial("Mercury_Armor", 15, new int[] { 3, 8, 6, 3 }, 13);
    private static ArmorMaterial uranium_ArmorMaterial = EnumHelper
        .addArmorMaterial("Uranium_Armor", 20, new int[] { 3, 8, 6, 3 }, 13);
    private static ArmorMaterial zinc_ArmorMaterial = EnumHelper
        .addArmorMaterial("Zinc_Armor", 45, new int[] { 3, 8, 6, 3 }, 9);
    private static ArmorMaterial tungsten_ArmorMaterial = EnumHelper
        .addArmorMaterial("Tungsten_Armor", 50, new int[] { 3, 8, 6, 3 }, 7);

    private static ArmorMaterial red_gem_ArmorMaterial = EnumHelper
        .addArmorMaterial("Red__gem_Armor", 28, new int[] { 3, 8, 6, 3 }, 7);
    private static ArmorMaterial white_gem_ArmorMaterial = EnumHelper
        .addArmorMaterial("White__gem_Armor", 40, new int[] { 3, 8, 6, 3 }, 7);
    private static ArmorMaterial blue_gem_ArmorMaterial = EnumHelper
        .addArmorMaterial("Blue__gem_Armor", 45, new int[] { 3, 8, 6, 3 }, 7);

    private static ArmorMaterial blue_diamond_ArmorMaterial = EnumHelper
        .addArmorMaterial("Blue__diamond_Armor", 28, new int[] { 3, 8, 6, 3 }, 7);
    private static ArmorMaterial red_diamond_ArmorMaterial = EnumHelper
        .addArmorMaterial("Red__diamond_Armor", 28, new int[] { 3, 8, 6, 3 }, 7);
    private static ArmorMaterial purple_diamond_ArmorMaterial = EnumHelper
        .addArmorMaterial("Purple__diamond_Armor", 28, new int[] { 3, 8, 6, 3 }, 7);
    private static ArmorMaterial yellow_diamond_ArmorMaterial = EnumHelper
        .addArmorMaterial("Yellow__diamond_Armor", 28, new int[] { 3, 8, 6, 3 }, 7);
    ...
    private static void initializeArmor() {
        if (Config.mercuryItems && Config.mercury) {
            ...
            mercuryLegings = new MercuryArmor("mercury", mercury_ArmorMaterial, 2)
                .setUnlocalizedName("mercury_legings");
        ...
        if (Config.uraniumItems && Config.ceres) {
            ...
            uraniumLegings = new UraniumArmor("uranium", uranium_ArmorMaterial, 2)
                .setUnlocalizedName("uranium_legings");
            uraniumBoots = new UraniumArmor("uranium", uranium_ArmorMaterial, 3).setUnlocalizedName("uranium_boots");
        }
        if (Config.jupiter) {
            if (Config.palladiumItems) {
                palladiumHelmet = new PalladiumArmor("palladium", palladium_ArmorMaterial, 0)
                    .setUnlocalizedName("palladium_helmet");
                palladiumChest = new PalladiumArmor("palladium", palladium_ArmorMaterial, 1)
                    .setUnlocalizedName("palladium_chest");
                palladiumLegings = new PalladiumArmor("palladium", palladium_ArmorMaterial, 2)
                    .setUnlocalizedName("palladium_legings");
                palladiumBoots = new PalladiumArmor("palladium", palladium_ArmorMaterial, 3)
                    .setUnlocalizedName("palladium_boots");
            }
            if (Config.redGemItems) {
                redGemHelmet = new RedGemArmor("red_gem", red_gem_ArmorMaterial, 0)
                    .setUnlocalizedName("red_gem_helmet");
                redGemChest = new RedGemArmor("red_gem", red_gem_ArmorMaterial, 1).setUnlocalizedName("red_gem_chest");
                redGemLegings = new RedGemArmor("red_gem", red_gem_ArmorMaterial, 2)
                    .setUnlocalizedName("red_gem_legings");
        ...
        if (Config.magnesiumItems && Config.saturn) {
            magnesiumHelmet = new MagnesiumArmor("magnesium", magnesium_ArmorMaterial, 0)
                .setUnlocalizedName("magnesium_helmet");
            magnesiumChest = new MagnesiumArmor("magnesium", magnesium_ArmorMaterial, 1)
                .setUnlocalizedName("magnesium_chest");
            magnesiumLegings = new MagnesiumArmor("magnesium", magnesium_ArmorMaterial, 2)
                .setUnlocalizedName("magnesium_legings");
            magnesiumBoots = new MagnesiumArmor("magnesium", magnesium_ArmorMaterial, 3)
                .setUnlocalizedName("magnesium_boots");
        }
        if (Config.crystalItems && Config.uranus) {
            ...
            crystalLegings = new CrystalArmor("crystal", crystal_ArmorMaterial, 2)
                .setUnlocalizedName("crystal_legings");
            crystalBoots = new CrystalArmor("crystal", crystal_ArmorMaterial, 3).setUnlocalizedName("crystal_boots");
            if (Config.whiteGemItems) {
                whiteGemHelmet = new WhiteGemArmor("white_gem", white_gem_ArmorMaterial, 0)
                    .setUnlocalizedName("white_gem_helmet");
                whiteGemChest = new WhiteGemArmor("white_gem", white_gem_ArmorMaterial, 1)
                    .setUnlocalizedName("white_gem_chest");
                whiteGemLegings = new WhiteGemArmor("white_gem", white_gem_ArmorMaterial, 2)
                    .setUnlocalizedName("white_gem_legings");
                whiteGemBoots = new WhiteGemArmor("white_gem", white_gem_ArmorMaterial, 3)
                    .setUnlocalizedName("white_gem_boots");
            }
        }
        if (Config.neptune) {
            if (Config.zincItems) {
            ...
            if (Config.blueGemItems) {
                blueGemHelmet = new BlueGemArmor("blue_gem", blue_gem_ArmorMaterial, 0)
                    .setUnlocalizedName("blue_gem_helmet");
                blueGemChest = new BlueGemArmor("blue_gem", blue_gem_ArmorMaterial, 1)
                    .setUnlocalizedName("blue_gem_chest");
                blueGemLegings = new BlueGemArmor("blue_gem", blue_gem_ArmorMaterial, 2)
                    .setUnlocalizedName("blue_gem_legings");
                blueGemBoots = new BlueGemArmor("blue_gem", blue_gem_ArmorMaterial, 3)
                    .setUnlocalizedName("blue_gem_boots");
            }
        }
        if (Config.tungstenItems && Config.pluto) {
            tungstenHelmet = new TungstenArmor("tungsten", tungsten_ArmorMaterial, 0)
                .setUnlocalizedName("tungsten_helmet");
            tungstenChest = new TungstenArmor("tungsten", tungsten_ArmorMaterial, 1)
                .setUnlocalizedName("tungsten_chest");
            tungstenLegings = new TungstenArmor("tungsten", tungsten_ArmorMaterial, 2)
                .setUnlocalizedName("tungsten_legings");
            tungstenBoots = new TungstenArmor("tungsten", tungsten_ArmorMaterial, 3)
                .setUnlocalizedName("tungsten_boots");
        }
        if (Config.kepler22b && Config.kepler22bItems && Config.keplerSolarSystems) {
            blueDiamondHelmet = new BlueDiamondArmor("blue_diamond", blue_diamond_ArmorMaterial, 0)
                .setUnlocalizedName("blue_diamond_helmet");
            blueDiamondChest = new BlueDiamondArmor("blue_diamond", blue_diamond_ArmorMaterial, 1)
                .setUnlocalizedName("blue_diamond_chest");
            blueDiamondLegings = new BlueDiamondArmor("blue_diamond", blue_diamond_ArmorMaterial, 2)
                .setUnlocalizedName("blue_diamond_legings");
            blueDiamondBoots = new BlueDiamondArmor("blue_diamond", blue_diamond_ArmorMaterial, 3)
                .setUnlocalizedName("blue_diamond_boots");

            redDiamondHelmet = new RedDiamondArmor("red_diamond", red_diamond_ArmorMaterial, 0)
                .setUnlocalizedName("red_diamond_helmet");
            redDiamondChest = new RedDiamondArmor("red_diamond", red_diamond_ArmorMaterial, 1)
                .setUnlocalizedName("red_diamond_chest");
            redDiamondLegings = new RedDiamondArmor("red_diamond", red_diamond_ArmorMaterial, 2)
                .setUnlocalizedName("red_diamond_legings");
            redDiamondBoots = new RedDiamondArmor("red_diamond", red_diamond_ArmorMaterial, 3)
                .setUnlocalizedName("red_diamond_boots");

            purpleDiamondHelmet = new PurpleDiamondArmor("purple_diamond", purple_diamond_ArmorMaterial, 0)
                .setUnlocalizedName("purple_diamond_helmet");
            purpleDiamondChest = new PurpleDiamondArmor("purple_diamond", purple_diamond_ArmorMaterial, 1)
                .setUnlocalizedName("purple_diamond_chest");
            purpleDiamondLegings = new PurpleDiamondArmor("purple_diamond", purple_diamond_ArmorMaterial, 2)
                .setUnlocalizedName("purple_diamond_legings");
            purpleDiamondBoots = new PurpleDiamondArmor("purple_diamond", purple_diamond_ArmorMaterial, 3)
                .setUnlocalizedName("purple_diamond_boots");

            yellowDiamondHelmet = new YellowDiamondArmor("yellow_diamond", yellow_diamond_ArmorMaterial, 0)
                .setUnlocalizedName("yellow_diamond_helmet");
            yellowDiamondChest = new YellowDiamondArmor("yellow_diamond", yellow_diamond_ArmorMaterial, 1)
                .setUnlocalizedName("yellow_diamond_chest");
            yellowDiamondLegings = new YellowDiamondArmor("yellow_diamond", yellow_diamond_ArmorMaterial, 2)
                .setUnlocalizedName("yellow_diamond_legings");
            yellowDiamondBoots = new YellowDiamondArmor("yellow_diamond", yellow_diamond_ArmorMaterial, 3)
                .setUnlocalizedName("yellow_diamond_boots");

            greenDiamondHelmet = new GreenDiamondArmor("green_diamond", green_diamond_ArmorMaterial, 0)
                .setUnlocalizedName("green_diamond_helmet");
            greenDiamondChest = new GreenDiamondArmor("green_diamond", green_diamond_ArmorMaterial, 1)
                .setUnlocalizedName("green_diamond_chest");
            greenDiamondLegings = new GreenDiamondArmor("green_diamond", green_diamond_ArmorMaterial, 2)
                .setUnlocalizedName("green_diamond_legings");
