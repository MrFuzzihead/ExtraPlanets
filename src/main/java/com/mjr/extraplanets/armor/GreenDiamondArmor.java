...
public class GreenDiamondArmor extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (stack.getItem() == ExtraPlanets_Armor.greenDiamondHelmet
            || stack.getItem() == ExtraPlanets_Armor.greenDiamondChest
            || stack.getItem() == ExtraPlanets_Armor.greenDiamondBoots) {
