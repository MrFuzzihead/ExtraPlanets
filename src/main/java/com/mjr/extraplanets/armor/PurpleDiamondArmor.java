...
public class PurpleDiamondArmor extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (stack.getItem() == ExtraPlanets_Armor.purpleDiamondHelmet
            || stack.getItem() == ExtraPlanets_Armor.purpleDiamondChest
            || stack.getItem() == ExtraPlanets_Armor.purpleDiamondBoots) {
