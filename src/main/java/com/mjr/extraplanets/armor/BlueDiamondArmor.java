...
public class BlueDiamondArmor extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        if (stack.getItem() == ExtraPlanets_Armor.blueDiamondHelmet
            || stack.getItem() == ExtraPlanets_Armor.blueDiamondChest
            || stack.getItem() == ExtraPlanets_Armor.blueDiamondBoots) {
