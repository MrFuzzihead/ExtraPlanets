...
public class StructureVillagePiecesPluto {
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightPluto> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightPluto> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentPlutoVillage func_75083_a(
        StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightPluto par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentPlutoVillageWoodHut.class) {
            var10 = StructureComponentPlutoVillageWoodHut
            ...
            var10 = StructureComponentPlutoVillageField
            ...
            var10 = StructureComponentPlutoVillageHouse
    ...
    private static StructureComponentPlutoVillage getNextVillageComponent(
        StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesPluto
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightPluto> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentPlutoVillage var13 = StructureVillagePiecesPluto.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentPlutoVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentPlutoVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentPlutoVillage var8 = StructureVillagePiecesPluto.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentPlutoVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentPlutoVillagePathGen var9 = new StructureComponentPlutoVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesPluto.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesPluto.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
