...
public class StructureVillageStartPluto extends StructureStart {
    ...
    public StructureVillageStartPluto(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightPluto> var6 = StructureVillagePiecesPluto
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentPlutoVillageStartPiece var7 = new StructureComponentPlutoVillageStartPiece(
