...
public class StructureComponentPlutoVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentPlutoVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.plutoBlocks;
    }

    public StructureComponentPlutoVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPlutoVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentPlutoVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
