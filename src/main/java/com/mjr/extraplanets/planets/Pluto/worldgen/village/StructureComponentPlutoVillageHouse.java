...
public class StructureComponentPlutoVillageHouse extends StructureComponentPlutoVillage {
    ...
    public StructureComponentPlutoVillageHouse(StructureComponentPlutoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public boolean addComponentParts(World par1World, Random par2Random,
        ...
        for (yLevel = -8; yLevel < 4; yLevel++) {
            ...
            this.placeBlockAtCurrentPosition(
                par1World,
                yLevel <= 1 ? ExtraPlanets_Blocks.plutoBlocks : Blocks.air,
                1,
                1,
                yLevel,
                8,
