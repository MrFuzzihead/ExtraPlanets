...
public class StructureComponentPlutoVillageField2 extends StructureComponentPlutoVillage {
    ...
    public StructureComponentPlutoVillageField2(StructureComponentPlutoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPlutoVillageField2 func_74900_a(
        StructureComponentPlutoVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentPlutoVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentPlutoVillageField2(
