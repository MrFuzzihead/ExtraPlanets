...
public class StructureComponentPlutoVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentPlutoVillageTorch() {}

    public StructureComponentPlutoVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
