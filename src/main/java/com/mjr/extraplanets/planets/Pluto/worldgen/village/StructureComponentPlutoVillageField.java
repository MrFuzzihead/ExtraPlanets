...
public class StructureComponentPlutoVillageField extends StructureComponentPlutoVillage {
    ...
    public StructureComponentPlutoVillageField(StructureComponentPlutoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPlutoVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentPlutoVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
