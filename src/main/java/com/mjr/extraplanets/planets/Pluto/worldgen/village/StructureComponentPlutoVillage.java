...
public abstract class StructureComponentPlutoVillage extends StructureComponent {
    ...
    protected StructureComponentPlutoVillage(StructureComponentPlutoVillageStartPiece par1ComponentVillageStartPiece,
        int par2) {
        super(par2);
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentPlutoVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesPluto.getNextStructureComponent(
