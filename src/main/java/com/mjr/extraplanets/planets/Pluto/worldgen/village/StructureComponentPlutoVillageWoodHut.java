...
public class StructureComponentPlutoVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentPlutoVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.plutoBlocks;
    }

    public StructureComponentPlutoVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPlutoVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentPlutoVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
