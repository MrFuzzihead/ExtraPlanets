...
public class ExtraPlanets_Planets {
    ...
    private static void initializePlanets() {
        if (Config.mercury) {
            mercury = new Planet(mercuryOverride ? "MercuryEP" : "Mercury")
            ...
            mercury.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    0.5F + Config.mercuryDistanceOffset,
                    0.5F + Config.mercuryDistanceOffset));
        ...
        if (Config.venus) {
            venus = new Planet(venusOverride ? "VenusEP" : "Venus")
                .setParentSolarSystem(GalacticraftCore.solarSystemSol);
            venus.setTierRequired(3);
            venus.setRingColorRGB(0.1F, 0.9F, 0.6F);
            venus.setPhaseShift(2.0F);
            venus.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    0.75F + Config.venusDistanceOffset,
                    0.75F + Config.venusDistanceOffset));
        ...
        if (Config.saturn) {
            saturn = new Planet(saturnOverride ? "SaturnEP" : "Saturn")
                .setParentSolarSystem(GalacticraftCore.solarSystemSol);
            if (Config.morePlanetsCompatibilityAdv143) saturn.setTierRequired(4);
            else saturn.setTierRequired(5);
            saturn.setRingColorRGB(0.1F, 0.9F, 0.6F);
            saturn.setPhaseShift(5.45F);
            saturn.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    2.00F + Config.saturnDistanceOffset,
                    2.00F + Config.saturnDistanceOffset));
            saturn.setRelativeOrbitTime(29.463307776560788608981380065717F);
            saturn.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
        ...
        if (Config.uranus) {
            uranus = new Planet(uranusOverride ? "UranusEP" : "Uranus")
                .setParentSolarSystem(GalacticraftCore.solarSystemSol);
            if (Config.morePlanetsCompatibilityAdv143) uranus.setTierRequired(4);
            else uranus.setTierRequired(6);
            uranus.setRingColorRGB(0.1F, 0.9F, 0.6F);
            uranus.setPhaseShift(1.38F);
            uranus.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    2.25F + Config.uranusDistanceOffset,
                    2.25F + Config.uranusDistanceOffset));
            uranus.setRelativeOrbitTime(84.063526834611171960569550930997F);
            uranus.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE)
        ...
        if (Config.neptune) {
            neptune = new Planet(neptuneOverride ? "NeptuneEP" : "Neptune")
                .setParentSolarSystem(GalacticraftCore.solarSystemSol);
            if (Config.morePlanetsCompatibilityAdv143) neptune.setTierRequired(5);
            else neptune.setTierRequired(7);
            neptune.setRingColorRGB(0.1F, 0.9F, 0.6F);
            neptune.setPhaseShift(1.0F);
            neptune.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    2.50F + Config.neptuneDistanceOffset,
                    2.50F + Config.neptuneDistanceOffset));
            neptune.setRelativeOrbitTime(164.84118291347207009857612267251F);
            neptune.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.WATER);
        ...
        if (Config.pluto) {
            pluto = new Planet(plutoOverride ? "PlutoEP" : "Pluto")
                .setParentSolarSystem(GalacticraftCore.solarSystemSol);
            pluto.setTierRequired(8);
            pluto.setRingColorRGB(0.1F, 0.9F, 0.6F);
            pluto.setPhaseShift(2.0F);
            pluto.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    2.75F + Config.plutoDistanceOffset,
                    2.75F + Config.plutoDistanceOffset));
            pluto.setRelativeOrbitTime((float) (164.84118291347207009857612267251 * 2));
            pluto.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.WATER);
            pluto
                .setBodyIcon(new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/pluto.png"));
        ...
        if (Config.eris) {
            ...
            if (Config.morePlanetsCompatibilityAdv143) eris.setTierRequired(6);
            else eris.setTierRequired(Config.morePlanetsCompatibility ? 8 : 9);
            eris.setRingColorRGB(0.1F, 0.9F, 0.6F);
            eris.setPhaseShift(1.0F);
            eris.setRelativeDistanceFromCenter(
                new CelestialBody.ScalableDistance(
                    3.50F + Config.erisDistanceOffset,
                    3.50F + Config.erisDistanceOffset));
            eris.setRelativeOrbitTime((float) (164.84118291347207009857612267251 * 3));
            eris.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.WATER);
        ...
        if (Config.kepler22b && Config.keplerSolarSystems) {
            ...
            if (Config.morePlanetsCompatibilityAdv143) kepler22b.setTierRequired(7);
            else kepler22b.setTierRequired(Config.morePlanetsCompatibility ? 8 : 10);
            ...
            kepler22b.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.WATER)
                .atmosphereComponent(IAtmosphericGas.OXYGEN);
            kepler22b.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler22b.png"));
    ...
    public static void initializeUnReachablePlanets() {
        if (Config.kuiperBelt) {
            ...
            if (kuiperBelt != null) kuiperBelt.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(
                    new CelestialBody.ScalableDistance(
                        4.0F + Config.kuiperBeltDistanceOffset,
                        4.0F + Config.kuiperBeltDistanceOffset))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            kuiperBelt.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kuiper_belt.png"));
        }
        if (Config.makemake) {
            makemake = RegisterHelper.registerUnreachablePlanet("makemake", GalacticraftCore.solarSystemSol);
            if (makemake != null) makemake.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(
                    new CelestialBody.ScalableDistance(
                        4.50F + Config.makemakeDistanceOffset,
                        4.50F + Config.makemakeDistanceOffset))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            makemake.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/makemake.png"));
        }
        if (Config.haumea) {
            haumea = RegisterHelper.registerUnreachablePlanet("haumea", GalacticraftCore.solarSystemSol);
            if (haumea != null) haumea.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(
                    new CelestialBody.ScalableDistance(
                        3.50F + Config.haumeaDistanceOffset,
                        3.50F + Config.haumeaDistanceOffset))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            haumea.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/haumea.png"));
        }
        if (Config.keplerSolarSystems) {
            ...
            if (kepler47b != null) kepler47b.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(0.5F, 0.5F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            kepler47b.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler47b.png"));

            kepler47c = RegisterHelper.registerUnreachablePlanet("kepler47c", ExtraPlanets_SolarSystems.kepler47);
            if (kepler47c != null) kepler47c.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(1.0F, 1.0F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            kepler47c.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler47c.png"));

            // Kepler 62 Solar System
            kepler62b = RegisterHelper.registerUnreachablePlanet("kepler62b", ExtraPlanets_SolarSystems.kepler62);
            if (kepler62b != null) kepler62b.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(0.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(0.5F, 0.5F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 6);
            kepler62b.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler62b.png"));

            kepler62c = RegisterHelper.registerUnreachablePlanet("kepler62c", ExtraPlanets_SolarSystems.kepler62);
            if (kepler62c != null) kepler62c.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(1.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(1.0F, 1.0F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 5);
            kepler62c.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler62c.png"));

            kepler62d = RegisterHelper.registerUnreachablePlanet("kepler62d", ExtraPlanets_SolarSystems.kepler62);
            if (kepler62d != null) kepler62d.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(2.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(1.50F, 1.50F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 4);
            kepler62d.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler62d.png"));

            kepler62e = RegisterHelper.registerUnreachablePlanet("kepler62e", ExtraPlanets_SolarSystems.kepler62);
            if (kepler62e != null) kepler62e.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(3.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(1.75F, 1.75F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 3);
            kepler62e.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler62e.png"));

            kepler62f = RegisterHelper.registerUnreachablePlanet("kepler62f", ExtraPlanets_SolarSystems.kepler62);
            if (kepler62f != null) kepler62f.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(4.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(2.0F, 2.0F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 2);
            kepler62f.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler62f.png"));

            // Kepler 69 Solar System
            kepler69b = RegisterHelper.registerUnreachablePlanet("kepler69b", ExtraPlanets_SolarSystems.kepler69);
            if (kepler69b != null) kepler69b.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(5.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(0.5F, 0.5F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F / 1);
            kepler69b.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler69b.png"));

            kepler69c = RegisterHelper.registerUnreachablePlanet("kepler69c", ExtraPlanets_SolarSystems.kepler69);
            if (kepler69c != null) kepler69c.setRingColorRGB(0.1F, 0.9F, 0.6F)
                .setPhaseShift(6.45F)
                .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(1.0F, 1.0F))
                .setRelativeOrbitTime(164.84118291347207009857612267251F);
            kepler69c.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/kepler69c.png"));
        }
    }
    ...
    private static void registerPlanets() {
        if (Config.mercury) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderMercury.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/mercury_rocket_gui.png"));
        }
        if (Config.venus) {
            ...
            GalacticraftRegistry.registerRocketGui(
                ...
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/venus_rocket_gui.png"));
        }
        if (Config.ceres) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderCeres.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/ceres_rocket_gui.png"));
        }
        if (Config.jupiter) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderJupiter.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/jupiter_rocket_gui.png"));
        }
        if (Config.saturn) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderSaturn.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/saturn_rocket_gui.png"));
        }
        if (Config.uranus) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderUranus.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/uranus_rocket_gui.png"));
        }
        if (Config.neptune) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderNeptune.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/neptune_rocket_gui.png"));
        }
        if (Config.pluto) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderPluto.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/pluto_rocket_gui.png"));
        }
        if (Config.eris) {
            GalaxyRegistry.registerPlanet(eris);
            GalacticraftRegistry.registerTeleportType(WorldProviderEris.class, new TeleportTypeEris());
            GalacticraftRegistry.registerRocketGui(
                WorldProviderEris.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/eris_rocket_gui.png"));
        }
        if (Config.kepler22b && Config.keplerSolarSystems) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderKepler22b.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/kepler22b_rocket_gui.png"));
        }
    }
}
