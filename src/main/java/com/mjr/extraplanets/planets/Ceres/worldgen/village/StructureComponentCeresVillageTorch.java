...
public class StructureComponentCeresVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentCeresVillageTorch() {}

    public StructureComponentCeresVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
