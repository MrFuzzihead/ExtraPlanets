...
public class StructureComponentCeresVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentCeresVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.ceresBlocks;
    }

    public StructureComponentCeresVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCeresVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentCeresVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
