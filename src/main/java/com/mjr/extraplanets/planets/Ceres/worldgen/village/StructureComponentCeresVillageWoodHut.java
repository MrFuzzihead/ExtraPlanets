...
public class StructureComponentCeresVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentCeresVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.ceresBlocks;
    }

    public StructureComponentCeresVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCeresVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentCeresVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
