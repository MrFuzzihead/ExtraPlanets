...
public class StructureVillageStartCeres extends StructureStart {
    ...
    public StructureVillageStartCeres(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightCeres> var6 = StructureVillagePiecesCeres
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentCeresVillageStartPiece var7 = new StructureComponentCeresVillageStartPiece(
