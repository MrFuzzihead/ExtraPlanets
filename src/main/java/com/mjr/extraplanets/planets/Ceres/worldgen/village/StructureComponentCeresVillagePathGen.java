...
public class StructureComponentCeresVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentCeresVillagePathGen() {}

    public StructureComponentCeresVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
