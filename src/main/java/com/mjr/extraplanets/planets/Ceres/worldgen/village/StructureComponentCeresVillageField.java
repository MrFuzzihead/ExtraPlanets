...
public class StructureComponentCeresVillageField extends StructureComponentVillageField {

    public StructureComponentCeresVillageField() {}

    public StructureComponentCeresVillageField(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
