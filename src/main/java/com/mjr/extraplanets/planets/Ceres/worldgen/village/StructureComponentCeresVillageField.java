...
public class StructureComponentCeresVillageField extends StructureComponentCeresVillage {
    ...
    public StructureComponentCeresVillageField(StructureComponentCeresVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCeresVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentCeresVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
