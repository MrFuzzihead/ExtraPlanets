...
public class StructureComponentCeresVillageField2 extends StructureComponentCeresVillage {
    ...
    public StructureComponentCeresVillageField2(StructureComponentCeresVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCeresVillageField2 func_74900_a(
        StructureComponentCeresVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentCeresVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentCeresVillageField2(
