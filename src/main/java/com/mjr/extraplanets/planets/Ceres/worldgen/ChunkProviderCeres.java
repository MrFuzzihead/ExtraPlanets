...
public class ChunkProviderCeres extends ChunkProviderSpace {
    ...
    public void onPopulate(IChunkProvider provider, int cX, int cZ) {
        if (Config.ceresVillages) this.villageGenerator.generateStructuresInChunk(this.worldObj, this.rand, cX, cZ);
    }

    @Override
    public void recreateStructures(int par1, int par2) {
        if (Config.ceresVillages) this.villageGenerator.func_151539_a(this, this.worldObj, par1, par2, (Block[]) null);
    }
}
