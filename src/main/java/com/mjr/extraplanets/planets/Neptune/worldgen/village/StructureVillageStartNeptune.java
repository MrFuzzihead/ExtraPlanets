...
public class StructureVillageStartNeptune extends StructureStart {
    ...
    public StructureVillageStartNeptune(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightNeptune> var6 = StructureVillagePiecesNeptune
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentNeptuneVillageStartPiece var7 = new StructureComponentNeptuneVillageStartPiece(
