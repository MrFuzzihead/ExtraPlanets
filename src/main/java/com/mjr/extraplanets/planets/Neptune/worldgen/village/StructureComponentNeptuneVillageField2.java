...
public class StructureComponentNeptuneVillageField2 extends StructureComponentNeptuneVillage {
    ...
    public StructureComponentNeptuneVillageField2(
        StructureComponentNeptuneVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentNeptuneVillageField2 func_74900_a(
        StructureComponentNeptuneVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentNeptuneVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentNeptuneVillageField2(
