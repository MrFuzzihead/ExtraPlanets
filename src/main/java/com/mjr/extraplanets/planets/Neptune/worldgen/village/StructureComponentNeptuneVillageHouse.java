...
public class StructureComponentNeptuneVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentNeptuneVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.neptuneBlocks;
    }

    public StructureComponentNeptuneVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentNeptuneVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentNeptuneVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
