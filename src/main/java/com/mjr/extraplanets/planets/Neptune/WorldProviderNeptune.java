...
public class WorldProviderNeptune extends WorldProviderSpace
    ...
    public float getGravity() {
        if (Config.oldStyleGravity) return 0.058F;
        else return 0.010F;
    }
    ...
    public int getSolarRadiationLevel() {
        return com.mjr.extraplanets.Config.neptuneRadiationAmount;
    }

    @Override
    public int getPressureLevel() {
        return com.mjr.extraplanets.Config.neptunePressureAmount;
    }
