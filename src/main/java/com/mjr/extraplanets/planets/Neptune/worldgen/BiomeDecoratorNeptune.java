...
public class BiomeDecoratorNeptune extends BiomeDecorator {
    ...
    public BiomeDecoratorNeptune() {
        ...
        this.ironGen = new WorldGenMinableMeta(
            ...
            ExtraPlanets_Blocks.neptuneBlocks,
            2);
        this.zincGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.neptuneBlocks,
            4,
            6,
            true,
            ExtraPlanets_Blocks.neptuneBlocks,
            2);
        this.frozenNitrogenGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.frozenNitrogen,
            8,
            0,
            true,
            ExtraPlanets_Blocks.neptuneBlocks,
            0);
        this.blueGemGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.neptuneBlocks,
            4,
            9,
            true,
    ...
    public void decorateChunk(World world, Random rand, BiomeGenBase biome, int xChunk, int zChunk) {
        ...
        if (this.rand.nextInt(20) == 1) {
            WorldGenHelper.generateStructure(
                new WorldGenFrozenNitrogenPile(),
                this.currentWorld,
                this.rand,
                this.chunkX,
                0,
