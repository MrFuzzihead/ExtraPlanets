...
public class StructureComponentNeptuneVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentNeptuneVillagePathGen() {}

    public StructureComponentNeptuneVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
