...
public class StructureComponentNeptuneVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentNeptuneVillageTorch() {}

    public StructureComponentNeptuneVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
