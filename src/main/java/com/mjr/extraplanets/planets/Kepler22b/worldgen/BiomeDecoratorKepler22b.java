...
public class BiomeDecoratorKepler22b extends BiomeDecorator {
    ...
    public void decorateChunk(World world, Random rand, BiomeGenBase biome, int xChunk, int zChunk) {
        ...
        MinecraftForge.EVENT_BUS
            .post(new DecorateBiomeEvent.Pre(this.currentWorld, this.rand, this.chunkX, this.chunkZ));

        for (int i = 0; TerrainGen.decorate(
            this.currentWorld,
            this.rand,
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.blueTreesPerChunk); i++) {
            if (this.rand.nextInt(10) == 0) {
                WorldGenHelper.generateLake(
                    this.currentWorld,
                    this.rand,
                    this.chunk_X,
        ...
        for (int i = 0; i < this.InfectedLakesPerChunk; i++) {
            if (this.rand.nextInt(15) == 0) {
                WorldGenHelper.generateLake(
                    ...
                    0,
                    this.chunk_Z,
                    ExtraPlanets_Fluids.infected_water,
                    Blocks.grass);
            }
        }
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.CUSTOM) && (i < 1); i++) {
            ...
            if (this.generateHuts) {
                if (this.rand.nextInt(200) == 1) {
                    switch (this.rand.nextInt(7)) {
                        case 1:
                            WorldGenHelper.generateStructureWithRandom(
                                new WorldGenBlueHut(),
                                this.currentWorld,
                                rand,
                                this.chunk_X,
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.CUSTOM) && (i < this.blueTowerPerChunk); i++) {
            if (this.rand.nextInt(100) == 1) {
                WorldGenHelper.generateStructureWithRandom(
                    new WorldGenBlueTower(),
                    this.currentWorld,
                    rand,
                    this.chunk_X,
                    0,
        ...
        for (int i = 0; i < this.treeWithNoLeafsPerChunk; i++) {
            ...
            new WorldGenKepler22bTree(
                true,
                8,
                0,
                0,
                false,
                ExtraPlanets_Blocks.kepler22bMapleSapling,
                ExtraPlanets_Blocks.kepler22bMapleLog2,
                Blocks.air).generate(this.currentWorld, this.rand, x, y, z);
        }
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.CUSTOM) && (i < this.purpleBigTreesPerChunk); i++) {
            if (this.rand.nextInt(100) == 1) {
                int x = chunk_X + this.rand.nextInt(8) + 8;
                int z = chunk_Z + this.rand.nextInt(8) + 8;
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.CUSTOM) && (i < this.blueBigTreesPerChunk); i++) {
            if (this.rand.nextInt(100) == 1) {
                int x = chunk_X + this.rand.nextInt(8) + 8;
                int z = chunk_Z + this.rand.nextInt(8) + 8;
                int y = this.currentWorld.getHeightValue(x, z);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.CUSTOM) && (i < this.redBigTreesPerChunk); i++) {
            if (this.rand.nextInt(100) == 1) {
                int x = chunk_X + this.rand.nextInt(8) + 8;
                int z = chunk_Z + this.rand.nextInt(8) + 8;
                int y = this.currentWorld.getHeightValue(x, z);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            WorldGenKepler22bTree tree = new WorldGenKepler22bTree(
                false,
                8,
                0,
                0,
                false,
                ExtraPlanets_Blocks.kepler22bMapleSapling,
                ExtraPlanets_Blocks.kepler22bMapleLog,
                ExtraPlanets_Blocks.kepler22bMapleLeaf);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.redTreesPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;

            WorldGenKepler22bTree tree1 = new WorldGenKepler22bTree(
                false,
                8,
                1,
                1,
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.purpleTreesPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;

            WorldGenKepler22bTree tree2 = new WorldGenKepler22bTree(
                false,
                8,
                2,
                2,
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.yellowTreesPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;

            WorldGenKepler22bTree tree3 = new WorldGenKepler22bTree(
                false,
                8,
                3,
                3,
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.greenTreesPerChunk); i++) {
            if (rand.nextInt(5) + 1 == 1) {
                ...
                WorldGenKepler22bTree tree3 = new WorldGenKepler22bTree(
                    ...
                    ExtraPlanets_Blocks.kepler22bMapleSapling,
                    ExtraPlanets_Blocks.kepler22bMapleLog2,
                    ExtraPlanets_Blocks.kepler22bMapleLeaf2);
                tree3.setScale(1.0D, 1.0D, 1.0D);
                tree3.generate(currentWorld, rand, x, this.currentWorld.getHeightValue(x, z), z);
            }
        }
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.TREE) && (i < this.brownTreesPerChunk); i++) {
            if (rand.nextInt(5) + 1 == 1) {
                int x = this.chunk_X + this.rand.nextInt(8) + 8;
                int z = this.chunk_Z + this.rand.nextInt(8) + 8;
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.blueShortGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.blueMedGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.blueTallGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.redShortGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.redMedGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.redTallGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.purpleShortGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.purpleMedGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.purpleTallGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.yellowShortGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.yellowMedGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.yellowTallGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.greenShortGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.greenMedGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        for (int i = 0; TerrainGen.decorate(
            ...
            this.chunk_X,
            this.chunk_Z,
            DecorateBiomeEvent.Decorate.EventType.GRASS) && (i < this.greenTallGrassPerChunk); i++) {
            int x = this.chunk_X + this.rand.nextInt(8) + 8;
            int z = this.chunk_Z + this.rand.nextInt(8) + 8;
            int y = this.rand.nextInt(256);
        ...
        MinecraftForge.EVENT_BUS
            .post(new DecorateBiomeEvent.Post(this.currentWorld, this.rand, this.chunkX, this.chunkZ));
        isDecorating = false;
    }
}
