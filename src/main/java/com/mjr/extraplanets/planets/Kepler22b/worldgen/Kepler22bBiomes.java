...
public class Kepler22bBiomes extends BiomeGenBase {
    ...
    public static final BiomeGenBase kepler22bPlains = new BiomeGenKepler22bPlains().setColor(112)
        .setBiomeName("Kepler22b Plains")
        .setHeight(height_LowPlains);
    public static final BiomeGenBase kepler22bBlueForest = new BiomeGenKepler22bBlueMapleForest().setColor(112)
        .setBiomeName("Kepler22b Blue Maple Forest")
        .setHeight(height_LowPlains);
    public static final BiomeGenBase kepler22bPurpleForest = new BiomeGenKepler22bPurpleMapleForest().setColor(112)
        .setBiomeName("Kepler22b Purple Maple Forest")
        .setHeight(height_LowPlains);
    public static final BiomeGenBase kepler22bRedForest = new BiomeGenKepler22bRedMapleForest().setColor(112)
        .setBiomeName("Kepler22b Red Maple Forest")
        .setHeight(height_LowPlains);
    public static final BiomeGenBase kepler22bYellowForest = new BiomeGenKepler22bYellowMapleForest().setColor(112)
        .setBiomeName("Kepler22b Yellow Maple Forest")
        .setHeight(height_LowPlains);
    public static final BiomeGenBase kepler22bRedDesert = new BiomeGenKepler22bRedDesert().setColor(112)
        .setBiomeName("Kepler22b Red Desert")
        .setHeight(height_MidHills);
    public static final BiomeGenBase kepler22bWasteLands = new BiomeGenKepler22bWasteLands().setColor(112)
        .setBiomeName("Kepler22b Waste Lands")
        .setHeight(new Height(-0.2F, 0.1F));
    public static final BiomeGenBase kepler22bDiamondPlains = new BiomeGenKepler22bDiamondPlains()
        .setBiomeName("Kepler22b Diamond Plains")
        .setHeight(new Height(0.125F, 0.05F));
    public static final BiomeGenBase kepler22bCoalPlains = new BiomeGenKepler22bCoalPlains()
        .setBiomeName("Kepler22b Coal Plains")
        .setHeight(new Height(0.125F, 0.05F));
    public static final BiomeGenBase kepler22bIronPlains = new BiomeGenKepler22bIronPlains()
        .setBiomeName("Kepler22b Iron Plains")
        .setHeight(new Height(0.125F, 0.05F));
    public static final BiomeGenBase kepler22bGoldPlains = new BiomeGenKepler22bGoldPlains()
        .setBiomeName("Kepler22b Gold Plains")
        .setHeight(new Height(0.125F, 0.05F));
    public static final BiomeGenBase kepler22bEmeraldPlains = new BiomeGenKepler22bEmeraldPlains()
        .setBiomeName("Kepler22b Emerald Plains")
        .setHeight(new Height(0.125F, 0.05F));
    ...
    @Override
    public void genTerrainBlocks(World world, Random rand, Block[] block, byte[] meta, int x, int z,
        double stoneNoise) {
