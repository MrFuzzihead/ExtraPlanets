...
public class StructureComponentKepler22bVillageField2 extends StructureComponentKepler22bVillage {
    ...
    public StructureComponentKepler22bVillageField2(
        StructureComponentKepler22bVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentKepler22bVillageField2 func_74900_a(
        StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentKepler22bVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentKepler22bVillageField2(
