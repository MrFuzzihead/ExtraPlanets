...
public class BiomeDecoratorKepler22bOres extends BiomeDecoratorSpace {
    ...
    public BiomeDecoratorKepler22bOres() {
        ...
        this.ironGen = new WorldGenMinableMeta(
            ...
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.denseCoal = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            5,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.blueDiamondOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            6,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.redDiamondOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            7,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.yellowDiamondOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            8,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.purpleDiamondOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            9,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.greenDiamondOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            8,
            10,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.marbleGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.decorativeBlocks,
            10,
            0,
            true,
            ExtraPlanets_Blocks.kepler22bBlocks,
            1);
        this.platinumOre = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.kepler22bBlocks,
            3,
            13,
            true,
