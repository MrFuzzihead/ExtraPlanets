...
public abstract class StructureComponentKepler22bVillage extends StructureComponent {
    ...
    protected StructureComponentKepler22bVillage(
        StructureComponentKepler22bVillageStartPiece par1ComponentVillageStartPiece, int par2) {
        super(par2);
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentKepler22bVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesKepler22b.getNextStructureComponent(
