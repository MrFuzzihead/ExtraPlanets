...
public class StructureVillagePiecesKepler22b {
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightKepler22b> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightKepler22b> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentKepler22bVillage func_75083_a(
        StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightKepler22b par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentKepler22bVillageWoodHut.class) {
            var10 = StructureComponentKepler22bVillageWoodHut
            ...
            var10 = StructureComponentKepler22bVillageField
            ...
            var10 = StructureComponentKepler22bVillageHouse
    ...
    private static StructureComponentKepler22bVillage getNextVillageComponent(
        StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesKepler22b
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightKepler22b> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentKepler22bVillage var13 = StructureVillagePiecesKepler22b.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentKepler22bVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentKepler22bVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentKepler22bVillage var8 = StructureVillagePiecesKepler22b.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentKepler22bVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentKepler22bVillagePathGen var9 = new StructureComponentKepler22bVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesKepler22b.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentKepler22bVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesKepler22b.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
