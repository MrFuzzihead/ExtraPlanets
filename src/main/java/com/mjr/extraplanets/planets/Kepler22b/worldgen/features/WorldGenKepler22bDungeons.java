...
public class WorldGenKepler22bDungeons extends WorldGenerator {
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        ...
        if (j1 >= 1 && j1 <= 5) {
            // System.out.println("Generating Kepler22b Dungeon at:" + p_76484_3_+ ", " + p_76484_4_+ ", " +
            // p_76484_5_);
            for (k1 = p_76484_3_ - l - 1; k1 <= p_76484_3_ + l + 1; ++k1) {
                for (l1 = p_76484_4_ + b0; l1 >= p_76484_4_ - 1; --l1) {
                    for (i2 = p_76484_5_ - i1 - 1; i2 <= p_76484_5_ + i1 + 1; ++i2) {
                        ...
                        } else if (l1 >= 0 && !p_76484_1_.getBlock(k1, l1 - 1, i2)
                            .getMaterial()
                            .isSolid()) {
                                p_76484_1_.setBlockToAir(k1, l1, i2);
                                ...
                                .isSolid()) {
                                    if (l1 == p_76484_4_ - 1 && p_76484_2_.nextInt(4) != 0) {
                                        p_76484_1_.setBlock(k1, l1, i2, ExtraPlanets_Blocks.kepler22bBlocks, 15, 2);// Kepler22b
                                                                                                                    // StoneBricks
                                    } else {
                                        p_76484_1_.setBlock(k1, l1, i2, ExtraPlanets_Blocks.kepler22bBlocks, 16, 2);// Kepler22b
                                                                                                                    // Cobblestone
                                    }
                                }
                    }
                                ...
                                if (k2 == 1) {
                                    ...
                                    if (tileentitychest != null) {
                                        WeightedRandomChestContent.generateChestContents(
                                            p_76484_2_,
                                            ChestGenHooks.getItems(DUNGEON_CHEST, p_76484_2_),
                                            tileentitychest,
