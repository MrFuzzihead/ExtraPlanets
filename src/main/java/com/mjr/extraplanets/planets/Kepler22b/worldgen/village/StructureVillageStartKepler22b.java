...
public class StructureVillageStartKepler22b extends StructureStart {
    ...
    public StructureVillageStartKepler22b(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightKepler22b> var6 = StructureVillagePiecesKepler22b
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentKepler22bVillageStartPiece var7 = new StructureComponentKepler22bVillageStartPiece(
