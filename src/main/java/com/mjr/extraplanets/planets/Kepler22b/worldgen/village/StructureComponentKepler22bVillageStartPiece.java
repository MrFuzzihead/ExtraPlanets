...
public class StructureComponentKepler22bVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentKepler22bVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.kepler22bBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentKepler22bVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2,
        Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightKepler22b> par6ArrayList,
        int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentKepler22bVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentKepler22bVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
