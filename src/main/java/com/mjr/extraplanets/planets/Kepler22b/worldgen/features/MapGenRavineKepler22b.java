...
public class MapGenRavineKepler22b extends MapGenBase {
                            ...
                            for (j3 = k4; j3 < j2; ++j3) {
                                ...
                                if (d13 * d13 + d14 * d14 < 1.0D) {
                                    for (int l3 = i2 - 1; l3 >= j4; --l3) {
                                        ...
                                        if ((d13 * d13 + d14 * d14) * this.field_75046_d[l3] + d11 * d11 / 6.0D
                                            < 1.0D) {
    ...
    /**
     * Digs out the current block, default implementation removes stone, filler, and top block Sets the block to lava if
     * y is less then 10, and air other wise. If setting to air, it also checks to see if we've broken the surface and
     * if so tries to
