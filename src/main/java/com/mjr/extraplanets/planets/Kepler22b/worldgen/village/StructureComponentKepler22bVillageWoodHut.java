...
public class StructureComponentKepler22bVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentKepler22bVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.kepler22bBlocks;
    }

    public StructureComponentKepler22bVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentKepler22bVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentKepler22bVillageWoodHut(
