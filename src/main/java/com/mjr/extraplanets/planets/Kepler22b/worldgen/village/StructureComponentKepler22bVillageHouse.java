...
import com.mjr.extraplanets.worldgen.village.StructureComponentVillageHouse;
import com.mjr.extraplanets.worldgen.village.StructureComponentVillageStartPiece;

public class StructureComponentKepler22bVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentKepler22bVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.kepler22bBlocks;
    }

    public StructureComponentKepler22bVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentKepler22bVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentKepler22bVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
