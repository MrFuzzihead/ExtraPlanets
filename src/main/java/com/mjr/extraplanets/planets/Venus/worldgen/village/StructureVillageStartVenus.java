...
public class StructureVillageStartVenus extends StructureStart {
    ...
    public StructureVillageStartVenus(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightVenus> var6 = StructureVillagePiecesVenus
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentVenusVillageStartPiece var7 = new StructureComponentVenusVillageStartPiece(
