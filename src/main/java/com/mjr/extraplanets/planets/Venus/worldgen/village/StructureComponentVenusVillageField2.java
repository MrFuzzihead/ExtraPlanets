...
public class StructureComponentVenusVillageField2 extends StructureComponentVenusVillage {
    ...
    public StructureComponentVenusVillageField2(StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentVenusVillageField2 func_74900_a(
        StructureComponentVenusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentVenusVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentVenusVillageField2(
