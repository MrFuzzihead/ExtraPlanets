...
public class StructureComponentVenusVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentVenusVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.venusBlocks;
    }

    public StructureComponentVenusVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentVenusVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentVenusVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
