...
public class StructureComponentVenusVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentVenusVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.venusBlocks;
    }

    public StructureComponentVenusVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentVenusVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentVenusVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
