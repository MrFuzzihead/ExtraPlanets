...
public class StructureComponentVenusVillagePathGen extends StructureComponentVenusVillageRoadPiece {
    ...
    public StructureComponentVenusVillagePathGen(
        StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
        ...
        for (var5 = par3Random.nextInt(5); var5 < this.averageGroundLevel - 8; var5 += 2 + par3Random.nextInt(5)) {
            var6 = this.getNextComponentNN(
                (StructureComponentVenusVillageStartPiece) par1StructureComponent,
                par2List,
                par3Random,
                0,
                var5);
        ...
        if (var4 && par3Random.nextInt(3) > 0) {
            switch (this.coordBaseMode) {
                case 0:
                    StructureVillagePiecesVenus.getNextStructureComponentVillagePath(
                        (StructureComponentVenusVillageStartPiece) par1StructureComponent,
                        par2List,
                        par3Random,
