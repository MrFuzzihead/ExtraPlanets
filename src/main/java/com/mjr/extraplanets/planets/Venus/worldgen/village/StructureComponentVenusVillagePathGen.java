...
public class StructureComponentVenusVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentVenusVillagePathGen() {}

    public StructureComponentVenusVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
