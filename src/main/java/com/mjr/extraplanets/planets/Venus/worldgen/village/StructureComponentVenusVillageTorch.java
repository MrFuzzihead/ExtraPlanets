...
public class StructureComponentVenusVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentVenusVillageTorch() {}

    public StructureComponentVenusVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
