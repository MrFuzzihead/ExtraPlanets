...
public abstract class StructureComponentVenusVillage extends StructureComponent {
    ...
    protected StructureComponentVenusVillage(StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece,
        int par2) {
        super(par2);
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesVenus.getNextStructureComponent(
