...
public class StructureComponentVenusVillageField extends StructureComponentVenusVillage {
    ...
    public StructureComponentVenusVillageField(StructureComponentVenusVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentVenusVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentVenusVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
