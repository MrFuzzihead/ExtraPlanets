...
public class SkyProviderJupiter extends IRenderHandler {
    ...
    private static final ResourceLocation overworldTexture = new ResourceLocation(
        com.mjr.extraplanets.Constants.ASSET_PREFIX,
        "textures/gui/celestialbodies/ceres.png");
    private static final ResourceLocation overworldTexture2 = new ResourceLocation(
        GalacticraftCore.ASSET_PREFIX,
        "textures/gui/celestialbodies/saturn.png");
    private static final ResourceLocation overworldTexture3 = new ResourceLocation(
        GalacticraftCore.ASSET_PREFIX,
        "textures/gui/celestialbodies/io.png");
    private static final ResourceLocation overworldTexture4 = new ResourceLocation(
        GalacticraftCore.ASSET_PREFIX,
        "textures/gui/celestialbodies/europa.png");
    private static final ResourceLocation overworldTexture5 = new ResourceLocation(
        GalacticraftCore.ASSET_PREFIX,
        "textures/gui/celestialbodies/ganymede.png");
    private static final ResourceLocation overworldTexture6 = new ResourceLocation(
        GalacticraftCore.ASSET_PREFIX,
        "textures/gui/celestialbodies/callisto.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture);
        tessellator1.startDrawingQuads();
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture2);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(0.6F, 0.6F, 0.6F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture3);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(0.6F, 0.6F, 0.6F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture4);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(0.6F, 0.6F, 0.6F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture5);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(0.6F, 0.6F, 0.6F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderJupiter.overworldTexture6);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
