...
public class StructureVillageStartJupiter extends StructureStart {
    ...
    public StructureVillageStartJupiter(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightJupiter> var6 = StructureVillagePiecesJupiter
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentJupiterVillageStartPiece var7 = new StructureComponentJupiterVillageStartPiece(
