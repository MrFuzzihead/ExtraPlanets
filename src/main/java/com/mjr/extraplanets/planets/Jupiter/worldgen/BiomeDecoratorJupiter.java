...
public class BiomeDecoratorJupiter extends BiomeDecorator {
    ...
    public BiomeDecoratorJupiter() {
        this.copperGen = new WorldGenMinableMeta(
            ...
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.tinGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterBlocks,
            4,
            4,
            true,
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.ironGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterBlocks,
            8,
            3,
            true,
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.palladiumGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterBlocks,
            4,
            6,
            true,
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.nickelGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterBlocks,
            4,
            7,
            true,
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.gravelGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterGravel,
            12,
            0,
            true,
            ExtraPlanets_Blocks.jupiterBlocks,
            2);
        this.redGemGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.jupiterBlocks,
            4,
            10,
            true,
        ...
        this.redSandGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.redSand,
            25,
            0,
            false,
            ExtraPlanets_Blocks.orangeSand,
            0);
        // WorldGenMinableMeta(Block OreBlock, int numberOfBlocks, int OreMeta, boolean usingMetaData, Block StoneBlock,
        // int StoneMeta);
    }
    ...
    public void decorateChunk(World world, Random rand, BiomeGenBase biome, int xChunk, int zChunk) {
        ...
        if (Config.genJupiterSkyFeature) this.generateOre(5, this.skyBlocksGen, 63, 256);
        ...
        for (int i = 0; i < this.LakesPerChunk; i++) {
            if (this.rand.nextInt(10) == 0) {
                WorldGenHelper.generateLake(
                    ...
                    0,
                    this.chunkZ,
                    ExtraPlanets_Fluids.magma,
                    ExtraPlanets_Blocks.jupiterBlocks);
            }
        }

        if (this.rand.nextInt(250) == 1) {
            WorldGenHelper.generateStructure(
                new WorldGenBasicHideout(),
                this.currentWorld,
                this.rand,
                this.chunkX,
                0,
