...
public class StructureComponentJupiterVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentJupiterVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.jupiterBlocks;
    }

    public StructureComponentJupiterVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentJupiterVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentJupiterVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
