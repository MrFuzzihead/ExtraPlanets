...
public abstract class StructureComponentJupiterVillage extends StructureComponent {
    ...
    protected StructureComponentJupiterVillage(
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentJupiterVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesJupiter.getNextStructureComponent(
        ...
        for (int var5 = this.boundingBox.minZ; var5 <= this.boundingBox.maxZ; ++var5) {
            for (int var6 = this.boundingBox.minX; var6 <= this.boundingBox.maxX; ++var6) {
                if (par1World.getTopSolidOrLiquidBlock(var5, var6) <= 100) {
                    for (int n = 0; n < 20; n++) {
                        if (par1World.getBlock(var5, 64 + n, var6) == Blocks.air) return 64 + n;
                    }
                } else {
                    return 100;
                }
