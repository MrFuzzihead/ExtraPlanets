...
public class StructureComponentJupiterVillageField2 extends StructureComponentJupiterVillage {
    ...
    public StructureComponentJupiterVillageField2(
        StructureComponentJupiterVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentJupiterVillageField2 func_74900_a(
        StructureComponentJupiterVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentJupiterVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentJupiterVillageField2(
