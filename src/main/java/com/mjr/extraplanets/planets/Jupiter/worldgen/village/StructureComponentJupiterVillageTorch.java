...
public class StructureComponentJupiterVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentJupiterVillageTorch() {}

    public StructureComponentJupiterVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
