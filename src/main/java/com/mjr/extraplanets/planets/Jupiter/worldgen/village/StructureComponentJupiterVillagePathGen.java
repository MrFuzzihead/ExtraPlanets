...
public class StructureComponentJupiterVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentJupiterVillagePathGen() {}

    public StructureComponentJupiterVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
