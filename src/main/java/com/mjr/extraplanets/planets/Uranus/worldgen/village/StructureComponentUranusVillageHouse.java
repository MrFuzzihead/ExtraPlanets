...
public class StructureComponentUranusVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentUranusVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.uranusBlocks;
    }

    public StructureComponentUranusVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentUranusVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentUranusVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
