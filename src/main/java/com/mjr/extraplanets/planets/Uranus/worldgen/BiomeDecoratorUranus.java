...
public class BiomeDecoratorUranus extends BiomeDecorator {
    ...
    public BiomeDecoratorUranus() {
        ...
        this.crystalGen = new WorldGenMinableMeta(
            ...
            ExtraPlanets_Blocks.uranusBlocks,
            2);
        this.denseIceGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.denseIce,
            8,
            0,
            true,
            ExtraPlanets_Blocks.uranusBlocks,
            0);
        this.whiteGemGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.uranusBlocks,
            4,
            6,
            true,
    ...
    public void decorateChunk(World world, Random rand, BiomeGenBase biome, int xChunk, int zChunk) {
        ...
        for (int i = 0; i < this.LakesPerChunk; i++) {
            if (this.rand.nextInt(10) == 0) {
                WorldGenHelper.generateLake(
                    ...
                    0,
                    this.chunkZ,
                    ExtraPlanets_Fluids.frozen_water,
                    ExtraPlanets_Blocks.uranusBlocks);
            }
        }
        if (Config.genUranusIceSpikes) {
            for (int i = 0; i < this.iceSpikesPerChunk; i++) {
                if (this.rand.nextInt(20) == 0) {
                    ...
                    new WorldGenCustomIceSpike()
                        .generate(this.currentWorld, this.rand, x, y, z, ExtraPlanets_Blocks.uranusBlocks);
                }
            }
        }
        if (Config.genUranusIgloos) {
            if (this.rand.nextInt(300) == 1) {
                WorldGenHelper
                    .generateStructure(new WorldGenIgloo(), this.currentWorld, this.rand, this.chunkX, 0, this.chunkZ);
            }
        }
