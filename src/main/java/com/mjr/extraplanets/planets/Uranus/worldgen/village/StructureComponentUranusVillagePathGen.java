...
public class StructureComponentUranusVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentUranusVillagePathGen() {}

    public StructureComponentUranusVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
