...
public class StructureComponentUranusVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentUranusVillageTorch() {}

    public StructureComponentUranusVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
