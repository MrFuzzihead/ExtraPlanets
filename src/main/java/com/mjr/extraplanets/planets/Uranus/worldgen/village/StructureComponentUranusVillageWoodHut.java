...
public class StructureComponentUranusVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentUranusVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.uranusBlocks;
    }

    public StructureComponentUranusVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentUranusVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentUranusVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
