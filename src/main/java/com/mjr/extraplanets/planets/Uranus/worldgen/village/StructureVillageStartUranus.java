...
public class StructureVillageStartUranus extends StructureStart {
    ...
    public StructureVillageStartUranus(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightUranus> var6 = StructureVillagePiecesUranus
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentUranusVillageStartPiece var7 = new StructureComponentUranusVillageStartPiece(
