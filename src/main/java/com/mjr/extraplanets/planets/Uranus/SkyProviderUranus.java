...
public class SkyProviderUranus extends IRenderHandler {
    ...
    private static final ResourceLocation overworldTexture3 = new ResourceLocation(
        ...
        "textures/gui/celestialbodies/titania.png");
    private static final ResourceLocation overworldTexture4 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/gui/celestialbodies/oberon.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderUranus.overworldTexture);
        tessellator1.startDrawingQuads();
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderUranus.overworldTexture2);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderUranus.overworldTexture3);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderUranus.overworldTexture4);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
