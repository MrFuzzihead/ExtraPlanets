...
public class ExtraPlanets_SpaceStations {
    ...
    private static void initializeSatellites() {
        if (Config.mercurySpaceStation && Config.mercury) {
            ...
            mercurySpaceStation.setDimensionInfo(
                Config.mercurySpaceStationID,
                Config.mercurySpaceStationStaticID,
                WorldProviderMercuryOrbit.class);
            mercurySpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.venusSpaceStation && Config.venus) {
            ...
            venusSpaceStation.setDimensionInfo(
                Config.venusSpaceStationID,
                Config.venusSpaceStationStaticID,
                WorldProviderVenusOrbit.class);
            venusSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.ceresSpaceStation && Config.ceres) {
            ...
            ceresSpaceStation.setDimensionInfo(
                Config.ceresSpaceStationID,
                Config.ceresSpaceStationStaticID,
                WorldProviderCeresOrbit.class);
            ceresSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.marsSpaceStation && MarsModule.planetMars != null) {
            ...
            marsSpaceStation.setDimensionInfo(
                Config.marsSpaceStationID,
                Config.marsSpaceStationStaticID,
                WorldProviderMarsOrbit.class);
            marsSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.jupiterSpaceStation && Config.jupiter) {
            ...
            jupiterSpaceStation.setDimensionInfo(
                Config.jupiterSpaceStationID,
                Config.jupiterSpaceStationStaticID,
                WorldProviderJupiterOrbit.class);
            jupiterSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.saturnSpaceStation && Config.saturn) {
            ...
            saturnSpaceStation.setDimensionInfo(
                Config.saturnSpaceStationID,
                Config.saturnSpaceStationStaticID,
                WorldProviderSaturnOrbit.class);
            saturnSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.uranusSpaceStation && Config.uranus) {
            ...
            uranusSpaceStation.setDimensionInfo(
                Config.uranusSpaceStationID,
                Config.uranusSpaceStationStaticID,
                WorldProviderUranusOrbit.class);
            uranusSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.neptuneSpaceStation && Config.neptune) {
            ...
            neptuneSpaceStation.setDimensionInfo(
                Config.neptuneSpaceStationID,
                Config.neptuneSpaceStationStaticID,
                WorldProviderNeptuneOrbit.class);
            neptuneSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.plutoSpaceStation && Config.pluto) {
            ...
            plutoSpaceStation.setDimensionInfo(
                Config.plutoSpaceStationID,
                Config.plutoSpaceStationStaticID,
                WorldProviderPlutoOrbit.class);
            plutoSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.erisSpaceStation && Config.eris) {
            ...
            erisSpaceStation.setDimensionInfo(
                Config.erisSpaceStationID,
                Config.erisSpaceStationStaticID,
                WorldProviderErisOrbit.class);
            erisSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
        if (Config.kepler22bSpaceStation && Config.kepler22b && Config.keplerSolarSystems) {
            kepler22bSpaceStation = new Satellite("spaceStation.kepler22b")
                .setParentBody(ExtraPlanets_Planets.kepler22b);
            ...
            kepler22bSpaceStation.setDimensionInfo(
                Config.kepler22bSpaceStationID,
                Config.kepler22bSpaceStationStaticID,
                WorldProviderKepler22bOrbit.class);
            kepler22bSpaceStation
                .setBodyIcon(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/spaceStation.png"));
        }
    }
    ...
    private static void registerSatellites() {
        if (Config.mercurySpaceStation && Config.mercury) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.mercurySpaceStationID, WorldProviderMercuryOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.mercurySpaceStationStaticID, WorldProviderMercuryOrbit.class, true, 0);
        }
        if (Config.venusSpaceStation && Config.venus) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.venusSpaceStationStaticID, WorldProviderVenusOrbit.class, true, 0);
        }
        if (Config.ceresSpaceStation && Config.ceres) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.ceresSpaceStationStaticID, WorldProviderCeresOrbit.class, true, 0);
        }
        if (Config.marsSpaceStation && MarsModule.planetMars != null) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.marsSpaceStationStaticID, WorldProviderMarsOrbit.class, true, 0);
        }
        if (Config.jupiterSpaceStation && Config.jupiter) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.jupiterSpaceStationID, WorldProviderJupiterOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.jupiterSpaceStationStaticID, WorldProviderJupiterOrbit.class, true, 0);
        }
        if (Config.saturnSpaceStation && Config.saturn) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.saturnSpaceStationID, WorldProviderSaturnOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.saturnSpaceStationStaticID, WorldProviderSaturnOrbit.class, true, 0);
        }
        if (Config.uranusSpaceStation && Config.uranus) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.uranusSpaceStationID, WorldProviderUranusOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.uranusSpaceStationStaticID, WorldProviderUranusOrbit.class, true, 0);
        }
        if (Config.neptuneSpaceStation && Config.neptune) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.neptuneSpaceStationID, WorldProviderNeptuneOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.neptuneSpaceStationStaticID, WorldProviderNeptuneOrbit.class, true, 0);
        }
        if (Config.plutoSpaceStation && Config.pluto) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.plutoSpaceStationStaticID, WorldProviderPlutoOrbit.class, true, 0);
        }
        if (Config.erisSpaceStation && Config.eris) {
            ...
            GalacticraftRegistry
                .registerProvider(Config.erisSpaceStationStaticID, WorldProviderErisOrbit.class, true, 0);
        }
        if (Config.kepler22bSpaceStation && Config.kepler22b && Config.keplerSolarSystems) {
            GalaxyRegistry.registerSatellite(kepler22bSpaceStation);
            GalacticraftRegistry
                .registerTeleportType(WorldProviderKepler22bOrbit.class, new TeleportTypeKepler22bOrbit());
            GalacticraftRegistry
                .registerProvider(Config.kepler22bSpaceStationID, WorldProviderKepler22bOrbit.class, false, 0);
            GalacticraftRegistry
                .registerProvider(Config.kepler22bSpaceStationStaticID, WorldProviderKepler22bOrbit.class, true, 0);
        }
    }
}
