...
public class StructureComponentMercuryVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentMercuryVillageTorch() {}

    public StructureComponentMercuryVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
