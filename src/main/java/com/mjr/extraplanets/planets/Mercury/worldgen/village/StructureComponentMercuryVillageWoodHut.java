...
public class StructureComponentMercuryVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentMercuryVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.mercuryBlocks;
    }

    public StructureComponentMercuryVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentMercuryVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentMercuryVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
