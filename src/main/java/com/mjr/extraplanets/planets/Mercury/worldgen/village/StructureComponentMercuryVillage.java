...
public abstract class StructureComponentMercuryVillage extends StructureComponent {
    ...
    protected StructureComponentMercuryVillage(
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentMercuryVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesMercury.getNextStructureComponent(
