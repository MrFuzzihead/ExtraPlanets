...
public class StructureComponentMercuryVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentMercuryVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.mercuryBlocks;
    }

    public StructureComponentMercuryVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentMercuryVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentMercuryVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
