...
public class StructureComponentMercuryVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentMercuryVillagePathGen() {}

    public StructureComponentMercuryVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
