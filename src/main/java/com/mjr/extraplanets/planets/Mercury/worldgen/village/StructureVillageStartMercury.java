...
public class StructureVillageStartMercury extends StructureStart {
    ...
    public StructureVillageStartMercury(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightMercury> var6 = StructureVillagePiecesMercury
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentMercuryVillageStartPiece var7 = new StructureComponentMercuryVillageStartPiece(
