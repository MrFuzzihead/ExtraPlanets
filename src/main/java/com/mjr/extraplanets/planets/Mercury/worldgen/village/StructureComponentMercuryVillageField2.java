...
public class StructureComponentMercuryVillageField2 extends StructureComponentMercuryVillage {
    ...
    public StructureComponentMercuryVillageField2(
        StructureComponentMercuryVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentMercuryVillageField2 func_74900_a(
        StructureComponentMercuryVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentMercuryVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentMercuryVillageField2(
