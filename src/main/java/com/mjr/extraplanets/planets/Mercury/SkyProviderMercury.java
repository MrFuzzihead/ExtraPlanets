...
public class SkyProviderMercury extends IRenderHandler {
    ...
    private static final ResourceLocation overworldTexture = new ResourceLocation(
        ...
        "textures/gui/celestialbodies/venus.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderMercury.overworldTexture2);
        tessellator1.startDrawingQuads();
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(SkyProviderMercury.overworldTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f10, -100.0D, f10, 0, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, f10, 1, 1);
        tessellator1.addVertexWithUV(f10, -100.0D, -f10, 1, 0);
