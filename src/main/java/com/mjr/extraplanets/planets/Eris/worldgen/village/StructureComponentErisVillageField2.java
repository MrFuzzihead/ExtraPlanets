...
public class StructureComponentErisVillageField2 extends StructureComponentErisVillage {
    ...
    public StructureComponentErisVillageField2(StructureComponentErisVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentErisVillageField2 func_74900_a(
        StructureComponentErisVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentErisVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentErisVillageField2(
