...
public class StructureComponentErisVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentErisVillageTorch() {}

    public StructureComponentErisVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
