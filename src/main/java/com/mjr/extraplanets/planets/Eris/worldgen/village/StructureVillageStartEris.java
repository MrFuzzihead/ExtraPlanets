...
public class StructureVillageStartEris extends StructureStart {
    ...
    public StructureVillageStartEris(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightEris> var6 = StructureVillagePiecesEris
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentErisVillageStartPiece var7 = new StructureComponentErisVillageStartPiece(
