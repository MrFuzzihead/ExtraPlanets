...
public class StructureComponentErisVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentErisVillagePathGen() {}

    public StructureComponentErisVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
