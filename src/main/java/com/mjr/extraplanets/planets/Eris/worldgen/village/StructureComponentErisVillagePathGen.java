...
public class StructureComponentErisVillagePathGen extends StructureComponentErisVillageRoadPiece {
    ...
    public StructureComponentErisVillagePathGen(StructureComponentErisVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random) {
        ...
        for (var5 = par3Random.nextInt(5); var5 < this.averageGroundLevel - 8; var5 += 2 + par3Random.nextInt(5)) {
            var6 = this.getNextComponentNN(
                (StructureComponentErisVillageStartPiece) par1StructureComponent,
                par2List,
                par3Random,
                0,
                var5);
        ...
        if (var4 && par3Random.nextInt(3) > 0) {
            switch (this.coordBaseMode) {
                case 0:
                    StructureVillagePiecesEris.getNextStructureComponentVillagePath(
                        (StructureComponentErisVillageStartPiece) par1StructureComponent,
                        par2List,
                        par3Random,
