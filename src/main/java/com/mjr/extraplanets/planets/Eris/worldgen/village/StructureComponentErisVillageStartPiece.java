...
public class StructureComponentErisVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentErisVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.erisBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentErisVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random,
        int par4, int par5, ArrayList<StructureVillagePieceWeightEris> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentErisVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentErisVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
