...
public class ChunkProviderEris extends ChunkProviderSpace {
    ...
    protected BiomeGenBase.SpawnListEntry[] getMonsters() {
        ...
        if (Config.evolvedWitch) monsters.add(new BiomeGenBase.SpawnListEntry(EntityEvolvedWitch.class, 8, 2, 3));
    ...
    public void onPopulate(IChunkProvider provider, int cX, int cZ) {
        if (Config.erisVillages) this.villageGenerator.generateStructuresInChunk(this.worldObj, this.rand, cX, cZ);
        this.dungeonGenerator.handleTileEntities(this.rand);
    }

    @Override
    public void recreateStructures(int par1, int par2) {
        if (Config.erisVillages) this.villageGenerator.func_151539_a(this, this.worldObj, par1, par2, (Block[]) null);
    }
}
