...
public class StructureComponentErisVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentErisVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.erisBlocks;
    }

    public StructureComponentErisVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentErisVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentErisVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
