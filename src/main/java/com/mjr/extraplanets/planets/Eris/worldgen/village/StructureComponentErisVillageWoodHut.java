...
public class StructureComponentErisVillageWoodHut extends StructureComponentErisVillage {
    ...
    public StructureComponentErisVillageWoodHut(StructureComponentErisVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public boolean addComponentParts(World par1World, Random par2Random,
        ...
        for (yLevel = -8; yLevel < 4; yLevel++) {
            ...
            this.placeBlockAtCurrentPosition(
                par1World,
                yLevel <= 1 ? ExtraPlanets_Blocks.erisBlocks : Blocks.air,
                1,
                1,
                yLevel,
                8,
