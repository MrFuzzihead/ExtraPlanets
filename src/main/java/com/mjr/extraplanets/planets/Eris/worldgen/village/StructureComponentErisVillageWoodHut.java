...
public class StructureComponentErisVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentErisVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.erisBlocks;
    }

    public StructureComponentErisVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentErisVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentErisVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
