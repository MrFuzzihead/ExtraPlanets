...
public class StructureComponentSaturnVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentSaturnVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.saturnBlocks;
    }

    public StructureComponentSaturnVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentSaturnVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentSaturnVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
