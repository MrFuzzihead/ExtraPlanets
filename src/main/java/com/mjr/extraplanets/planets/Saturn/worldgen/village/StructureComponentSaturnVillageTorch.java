...
public class StructureComponentSaturnVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentSaturnVillageTorch() {}

    public StructureComponentSaturnVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
