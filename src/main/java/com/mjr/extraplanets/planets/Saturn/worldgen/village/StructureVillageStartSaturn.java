...
public class StructureVillageStartSaturn extends StructureStart {
    ...
    public StructureVillageStartSaturn(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightSaturn> var6 = StructureVillagePiecesSaturn
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentSaturnVillageStartPiece var7 = new StructureComponentSaturnVillageStartPiece(
