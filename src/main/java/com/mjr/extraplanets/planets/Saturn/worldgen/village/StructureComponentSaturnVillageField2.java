...
public class StructureComponentSaturnVillageField2 extends StructureComponentSaturnVillage {
    ...
    public StructureComponentSaturnVillageField2(
        StructureComponentSaturnVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentSaturnVillageField2 func_74900_a(
        StructureComponentSaturnVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentSaturnVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentSaturnVillageField2(
