...
public class StructureComponentSaturnVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentSaturnVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.saturnBlocks;
    }

    public StructureComponentSaturnVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentSaturnVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentSaturnVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
