...
public class StructureComponentSaturnVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentSaturnVillagePathGen() {}

    public StructureComponentSaturnVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
