...
public class BiomeDecoratorSaturn extends BiomeDecorator {
    ...
    public BiomeDecoratorSaturn() {
        ...
        this.magnesiumGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.saturnBlocks,
            4,
            6,
            true,
        ...
        this.gravelGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.saturnGravel,
            12,
            0,
            true,
            ExtraPlanets_Blocks.saturnBlocks,
            2);
        this.slimeGen = new WorldGenMinableMeta(
            ExtraPlanets_Blocks.saturnBlocks,
            12,
            11,
            true,
            ...
            for (int i = 0; i < LakesPerChunk * 2; i++) {
                if (this.rand.nextInt(10) == 0) {
                    WorldGenHelper.generateLake(
                        ...
                        0,
                        this.chunkZ,
                        ExtraPlanets_Fluids.methane,
                        ExtraPlanets_Blocks.saturnBlocks);
                }
            }
            if (this.rand.nextInt(5) == 1) {
                WorldGenHelper.generateStructure(
                    new WorldGenNuclearPile(),
                    this.currentWorld,
                    this.rand,
                    this.chunkX + (this.rand.nextInt(16)),
                    0,
                    this.chunkZ + (this.rand.nextInt(16)));
            }
            if (this.rand.nextInt(5) == 1) {
                WorldGenHelper.generateStructure(
                    new WorldGenSlimeTree(),
                    this.currentWorld,
                    this.rand,
                    this.chunkX + (this.rand.nextInt(16)),
                    0,
