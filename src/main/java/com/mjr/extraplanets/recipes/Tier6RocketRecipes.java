...
public class Tier6RocketRecipes {
    ...
    public static void registerRocketCraftingRecipe() {
        ...
        input.put(21, null);
        Tier6RocketRecipes
            .addTier6RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, 0), input));
        ...
        input2.put(21, null);
        Tier6RocketRecipes
            .addTier6RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, 1), input2));
        ...
        input2.put(21, null);
        Tier6RocketRecipes
            .addTier6RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, 2), input2));
        ...
        input2.put(21, new ItemStack(Blocks.chest));
        Tier6RocketRecipes
            .addTier6RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier6Rocket, 1, 3), input2));
    }
}
