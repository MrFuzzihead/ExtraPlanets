...
public class VenusRoverRecipes {
    ...
    public static void registerRoverCraftingRecipe() {
        ...
        input.put(24, null);
        VenusRoverRecipes
            .addVenusRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.venusRover, 1, 0), input));
        ...
        input.put(24, null);
        VenusRoverRecipes
            .addVenusRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.venusRover, 1, 1), input2));
        ...
        input2.put(24, null);
        VenusRoverRecipes
            .addVenusRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.venusRover, 1, 2), input2));
        ...
        input2.put(24, new ItemStack(Blocks.chest));
        VenusRoverRecipes
            .addVenusRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.venusRover, 1, 3), input2));
    }
}
