...
public class MarsRoverRecipes {
    ...
    public static void registerRoverCraftingRecipe() {
        ...
        input.put(24, null);
        MarsRoverRecipes
            .addMarsRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.marsRover, 1, 0), input));
        ...
        input.put(24, null);
        MarsRoverRecipes
            .addMarsRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.marsRover, 1, 1), input2));
        ...
        input2.put(24, null);
        MarsRoverRecipes
            .addMarsRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.marsRover, 1, 2), input2));
        ...
        input2.put(24, new ItemStack(Blocks.chest));
        MarsRoverRecipes
            .addMarsRoverRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.marsRover, 1, 3), input2));
    }
}
