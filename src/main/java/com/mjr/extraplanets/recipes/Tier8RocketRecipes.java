...
public class Tier8RocketRecipes {
    ...
    public static void registerRocketCraftingRecipe() {
        ...
        input.put(21, null);
        Tier8RocketRecipes
            .addTier8RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier8Rocket, 1, 0), input));
        ...
        input2.put(21, null);
        Tier8RocketRecipes
            .addTier8RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier8Rocket, 1, 1), input2));
        ...
        input2.put(21, null);
        Tier8RocketRecipes
            .addTier8RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier8Rocket, 1, 2), input2));
        ...
        input2.put(21, new ItemStack(Blocks.chest));
        Tier8RocketRecipes
            .addTier8RocketRecipe(new NasaWorkbenchRecipe(new ItemStack(ExtraPlanets_Items.tier8Rocket, 1, 3), input2));
    }
}
