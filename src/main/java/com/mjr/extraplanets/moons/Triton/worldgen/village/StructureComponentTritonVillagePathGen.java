...
public class StructureComponentTritonVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentTritonVillagePathGen() {}

    public StructureComponentTritonVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
