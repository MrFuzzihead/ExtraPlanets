...
public class StructureComponentTritonVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentTritonVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.tritonBlocks;
    }

    public StructureComponentTritonVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTritonVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTritonVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
