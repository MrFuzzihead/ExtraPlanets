...
public class StructureComponentTritonVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentTritonVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.tritonBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentTritonVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2,
        Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightTriton> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentTritonVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentTritonVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
