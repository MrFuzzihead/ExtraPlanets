...
public class StructureComponentTritonVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentTritonVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.tritonBlocks;
    }

    public StructureComponentTritonVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTritonVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTritonVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
