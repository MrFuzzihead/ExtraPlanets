...
public class StructureVillagePiecesTriton {
    ...
    public static ArrayList<StructureVillagePieceWeightTriton> getStructureVillageWeightedPieceList(Random par0Random,
        int par1) {
        final ArrayList<StructureVillagePieceWeightTriton> var2 = new ArrayList<StructureVillagePieceWeightTriton>();
        var2.add(
            new StructureVillagePieceWeightTriton(
                StructureComponentTritonVillageWoodHut.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 2 + par1, 5 + par1 * 3)));
        var2.add(
            new StructureVillagePieceWeightTriton(
                StructureComponentTritonVillageField.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 3 + par1, 5 + par1)));
        var2.add(
            new StructureVillagePieceWeightTriton(
                StructureComponentTritonVillageHouse.class,
                5,
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightTriton> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightTriton> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentTritonVillage func_75083_a(
        StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightTriton par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentTritonVillageWoodHut.class) {
            var10 = StructureComponentTritonVillageWoodHut
            ...
            var10 = StructureComponentTritonVillageField
            ...
            var10 = StructureComponentTritonVillageHouse
    ...
    private static StructureComponentTritonVillage getNextVillageComponent(
        StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesTriton
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightTriton> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentTritonVillage var13 = StructureVillagePiecesTriton.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentTritonVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentTritonVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentTritonVillage var8 = StructureVillagePiecesTriton.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentTritonVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentTritonVillagePathGen var9 = new StructureComponentTritonVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesTriton.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesTriton.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
