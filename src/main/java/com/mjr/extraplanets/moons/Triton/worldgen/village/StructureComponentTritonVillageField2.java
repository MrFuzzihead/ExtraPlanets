...
public class StructureComponentTritonVillageField2 extends StructureComponentTritonVillage {
    ...
    public StructureComponentTritonVillageField2(
        StructureComponentTritonVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentTritonVillageField2 func_74900_a(
        StructureComponentTritonVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentTritonVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentTritonVillageField2(
