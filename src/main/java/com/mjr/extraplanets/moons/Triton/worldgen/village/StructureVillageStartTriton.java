...
public class StructureVillageStartTriton extends StructureStart {
    ...
    public StructureVillageStartTriton(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightTriton> var6 = StructureVillagePiecesTriton
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentTritonVillageStartPiece var7 = new StructureComponentTritonVillageStartPiece(
