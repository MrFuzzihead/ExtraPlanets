...
public class StructureComponentTritonVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentTritonVillageTorch() {}

    public StructureComponentTritonVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
