...
public class StructureComponentDeimosVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentDeimosVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.deimosBlocks;
    }

    public StructureComponentDeimosVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentDeimosVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentDeimosVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
