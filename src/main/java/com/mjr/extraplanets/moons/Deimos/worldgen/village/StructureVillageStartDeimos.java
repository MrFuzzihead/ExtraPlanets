...
public class StructureVillageStartDeimos extends StructureStart {
    ...
    public StructureVillageStartDeimos(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightDeimos> var6 = StructureVillagePiecesDeimos
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentDeimosVillageStartPiece var7 = new StructureComponentDeimosVillageStartPiece(
