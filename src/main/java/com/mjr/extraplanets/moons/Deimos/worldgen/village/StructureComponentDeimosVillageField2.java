...
public class StructureComponentDeimosVillageField2 extends StructureComponentDeimosVillage {
    ...
    public StructureComponentDeimosVillageField2(
        StructureComponentDeimosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentDeimosVillageField2 func_74900_a(
        StructureComponentDeimosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentDeimosVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentDeimosVillageField2(
