...
public class StructureComponentDeimosVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentDeimosVillagePathGen() {}

    public StructureComponentDeimosVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
