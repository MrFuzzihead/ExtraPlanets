...
public class StructureComponentDeimosVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentDeimosVillageTorch() {}

    public StructureComponentDeimosVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
