...
public class StructureComponentPhobosVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentPhobosVillageTorch() {}

    public StructureComponentPhobosVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
