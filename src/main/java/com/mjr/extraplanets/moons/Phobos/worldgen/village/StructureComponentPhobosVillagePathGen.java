...
public class StructureComponentPhobosVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentPhobosVillagePathGen() {}

    public StructureComponentPhobosVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
