...
public class StructureComponentPhobosVillageField2 extends StructureComponentPhobosVillage {
    ...
    public StructureComponentPhobosVillageField2(
        StructureComponentPhobosVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentPhobosVillageField2 func_74900_a(
        StructureComponentPhobosVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentPhobosVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentPhobosVillageField2(
