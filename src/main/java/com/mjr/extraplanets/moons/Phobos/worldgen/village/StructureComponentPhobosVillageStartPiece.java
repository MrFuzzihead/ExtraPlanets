...
public class StructureComponentPhobosVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentPhobosVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.phobosBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentPhobosVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2,
        Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightPhobos> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentPhobosVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentPhobosVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
