...
public abstract class StructureComponentPhobosVillage extends StructureComponent {
    ...
    protected StructureComponentPhobosVillage(StructureComponentPhobosVillageStartPiece par1ComponentVillageStartPiece,
        int par2) {
        super(par2);
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentPhobosVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesPhobos.getNextStructureComponent(
