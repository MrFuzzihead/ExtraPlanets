...
public class StructureComponentPhobosVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentPhobosVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.phobosBlocks;
    }

    public StructureComponentPhobosVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPhobosVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentPhobosVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
