...
public class StructureComponentPhobosVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentPhobosVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.phobosBlocks;
    }

    public StructureComponentPhobosVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentPhobosVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentPhobosVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
