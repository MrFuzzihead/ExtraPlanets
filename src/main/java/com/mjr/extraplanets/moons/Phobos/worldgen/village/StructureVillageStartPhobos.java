...
public class StructureVillageStartPhobos extends StructureStart {
    ...
    public StructureVillageStartPhobos(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightPhobos> var6 = StructureVillagePiecesPhobos
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentPhobosVillageStartPiece var7 = new StructureComponentPhobosVillageStartPiece(
