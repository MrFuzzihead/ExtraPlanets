...
public class StructureComponentTitanVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentTitanVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.titanBlocks;
    }

    public StructureComponentTitanVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTitanVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTitanVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
