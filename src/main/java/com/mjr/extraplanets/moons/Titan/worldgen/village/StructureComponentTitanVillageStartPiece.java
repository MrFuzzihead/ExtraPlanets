...
public class StructureComponentTitanVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentTitanVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.titanBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentTitanVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2,
        Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightTitan> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentTitanVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentTitanVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
