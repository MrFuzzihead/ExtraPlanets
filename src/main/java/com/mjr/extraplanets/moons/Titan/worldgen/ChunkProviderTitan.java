...
public class ChunkProviderTitan extends ChunkProviderCustomSpace {
    ...
    public void recreateStructures(int par1, int par2) {
        if (Config.titanVillages) this.villageGenerator.func_151539_a(this, this.worldObj, par1, par2, (Block[]) null);
    }
    ...
    public void onPopulate(int cX, int cZ) {
        if (Config.titanVillages) this.villageGenerator.generateStructuresInChunk(this.worldObj, this.rand, cX, cZ);
    }
}
