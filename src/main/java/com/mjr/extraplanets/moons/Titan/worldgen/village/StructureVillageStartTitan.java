...
public class StructureVillageStartTitan extends StructureStart {
    ...
    public StructureVillageStartTitan(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightTitan> var6 = StructureVillagePiecesTitan
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentTitanVillageStartPiece var7 = new StructureComponentTitanVillageStartPiece(
