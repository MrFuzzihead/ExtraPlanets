...
public class StructureComponentTitanVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentTitanVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.titanBlocks;
    }

    public StructureComponentTitanVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTitanVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTitanVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
