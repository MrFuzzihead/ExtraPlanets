...
public class StructureVillagePieceWeightTitan extends StructureVillagePieceWeight {

    public StructureVillagePieceWeightTitan(Class<? extends StructureComponentVillage> par1Class, int par2, int par3) {
