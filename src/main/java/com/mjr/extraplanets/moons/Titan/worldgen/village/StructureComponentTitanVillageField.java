...
public class StructureComponentTitanVillageField extends StructureComponentTitanVillage {
    ...
    public StructureComponentTitanVillageField(StructureComponentTitanVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTitanVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTitanVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
