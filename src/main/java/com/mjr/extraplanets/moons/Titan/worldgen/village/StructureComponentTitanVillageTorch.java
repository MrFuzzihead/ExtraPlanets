...
public class StructureComponentTitanVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentTitanVillageTorch() {}

    public StructureComponentTitanVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
