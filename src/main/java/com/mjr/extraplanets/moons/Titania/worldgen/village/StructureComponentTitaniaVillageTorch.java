...
public class StructureComponentTitaniaVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentTitaniaVillageTorch() {}

    public StructureComponentTitaniaVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
