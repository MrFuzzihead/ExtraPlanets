...
public class StructureComponentTitaniaVillageField2 extends StructureComponentTitaniaVillage {
    ...
    public StructureComponentTitaniaVillageField2(
        StructureComponentTitaniaVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentTitaniaVillageField2 func_74900_a(
        StructureComponentTitaniaVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentTitaniaVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentTitaniaVillageField2(
