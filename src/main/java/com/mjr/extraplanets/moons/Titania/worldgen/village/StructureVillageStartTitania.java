...
public class StructureVillageStartTitania extends StructureStart {
    ...
    public StructureVillageStartTitania(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightTitania> var6 = StructureVillagePiecesTitania
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentTitaniaVillageStartPiece var7 = new StructureComponentTitaniaVillageStartPiece(
