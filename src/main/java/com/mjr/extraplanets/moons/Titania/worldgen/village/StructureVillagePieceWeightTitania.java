...
public class StructureVillagePieceWeightTitania extends StructureVillagePieceWeight {

    public StructureVillagePieceWeightTitania(Class<? extends StructureComponentVillage> par1Class, int par2,
        int par3) {
