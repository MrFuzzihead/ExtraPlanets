...
public class StructureComponentTitaniaVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentTitaniaVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.titaniaBlocks;
    }

    public StructureComponentTitaniaVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentTitaniaVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentTitaniaVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
