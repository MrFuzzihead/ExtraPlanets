...
public class StructureComponentTitaniaVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentTitaniaVillagePathGen() {}

    public StructureComponentTitaniaVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
