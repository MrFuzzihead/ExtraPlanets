...
public class StructureComponentTitaniaVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentTitaniaVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.titaniaBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentTitaniaVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2,
        Random par3Random, int par4, int par5, ArrayList<StructureVillagePieceWeightTitania> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentTitaniaVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentTitaniaVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
