...
public abstract class StructureComponentTitaniaVillage extends StructureComponent {
    ...
    protected StructureComponentTitaniaVillage(
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentTitaniaVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesTitania.getNextStructureComponent(
