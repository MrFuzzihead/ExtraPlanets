...
public class StructureComponentEuropaVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentEuropaVillageTorch() {}

    public StructureComponentEuropaVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
