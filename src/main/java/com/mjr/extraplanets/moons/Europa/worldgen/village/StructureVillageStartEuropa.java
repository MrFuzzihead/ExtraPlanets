...
public class StructureVillageStartEuropa extends StructureStart {
    ...
    public StructureVillageStartEuropa(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightEuropa> var6 = StructureVillagePiecesEuropa
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentEuropaVillageStartPiece var7 = new StructureComponentEuropaVillageStartPiece(
