...
public class StructureVillagePiecesEuropa {
    ...
    public static ArrayList<StructureVillagePieceWeightEuropa> getStructureVillageWeightedPieceList(Random par0Random,
        int par1) {
        final ArrayList<StructureVillagePieceWeightEuropa> var2 = new ArrayList<StructureVillagePieceWeightEuropa>();
        var2.add(
            new StructureVillagePieceWeightEuropa(
                StructureComponentEuropaVillageWoodHut.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 2 + par1, 5 + par1 * 3)));
        var2.add(
            new StructureVillagePieceWeightEuropa(
                StructureComponentEuropaVillageField.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 3 + par1, 5 + par1)));
        var2.add(
            new StructureVillagePieceWeightEuropa(
                StructureComponentEuropaVillageHouse.class,
                5,
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightEuropa> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightEuropa> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentEuropaVillage func_75083_a(
        StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightEuropa par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentEuropaVillageWoodHut.class) {
            var10 = StructureComponentEuropaVillageWoodHut
            ...
            var10 = StructureComponentEuropaVillageField
            ...
            var10 = StructureComponentEuropaVillageHouse
    ...
    private static StructureComponentEuropaVillage getNextVillageComponent(
        StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesEuropa
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightEuropa> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentEuropaVillage var13 = StructureVillagePiecesEuropa.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentEuropaVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentEuropaVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentEuropaVillage var8 = StructureVillagePiecesEuropa.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentEuropaVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentEuropaVillagePathGen var9 = new StructureComponentEuropaVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesEuropa.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesEuropa.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
