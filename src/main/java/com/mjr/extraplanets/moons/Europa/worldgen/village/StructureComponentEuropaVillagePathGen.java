...
public class StructureComponentEuropaVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentEuropaVillagePathGen() {}

    public StructureComponentEuropaVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
