...
public class StructureComponentEuropaVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentEuropaVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.europaBlocks;
    }

    public StructureComponentEuropaVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentEuropaVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentEuropaVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
