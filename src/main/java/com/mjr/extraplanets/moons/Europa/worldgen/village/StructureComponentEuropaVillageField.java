...
public class StructureComponentEuropaVillageField extends StructureComponentEuropaVillage {
    ...
    public StructureComponentEuropaVillageField(
        StructureComponentEuropaVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentEuropaVillageField func_74900_a(
        StructureComponentEuropaVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentEuropaVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
