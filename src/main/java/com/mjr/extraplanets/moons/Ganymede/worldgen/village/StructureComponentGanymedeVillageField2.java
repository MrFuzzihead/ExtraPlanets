...
public class StructureComponentGanymedeVillageField2 extends StructureComponentGanymedeVillage {
    ...
    public StructureComponentGanymedeVillageField2(
        StructureComponentGanymedeVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentGanymedeVillageField2 func_74900_a(
        StructureComponentGanymedeVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentGanymedeVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentGanymedeVillageField2(
