...
public class StructureVillageStartGanymede extends StructureStart {
    ...
    public StructureVillageStartGanymede(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightGanymede> var6 = StructureVillagePiecesGanymede
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentGanymedeVillageStartPiece var7 = new StructureComponentGanymedeVillageStartPiece(
