...
public class StructureComponentGanymedeVillageField extends StructureComponentVillageField {

    public StructureComponentGanymedeVillageField() {}

    public StructureComponentGanymedeVillageField(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
