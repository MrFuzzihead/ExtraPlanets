...
public class StructureComponentGanymedeVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentGanymedeVillagePathGen() {}

    public StructureComponentGanymedeVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
