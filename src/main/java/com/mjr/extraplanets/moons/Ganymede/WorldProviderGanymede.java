...
public class WorldProviderGanymede extends WorldProviderSpace
    ...
    public float getGravity() {
        if (Config.oldStyleGravity) return 0.062F;
        else return 0.015F;
    }
    ...
    public float getFallDamageModifier() {
        if (Config.oldStyleGravity) return 0.18F;
        else return 2.1F;
    }
    ...
    public float getThermalLevelModifier() {
        if (Config.thermalPaddings) {
            if (FMLCommonHandler.instance()
                .getEffectiveSide() == Side.SERVER && isDaytime()) {
                return 100.0F;
            }
            return -90.0F;
        } else return -1.5F;
    ...
    public int getSolarRadiationLevel() {
        return com.mjr.extraplanets.Config.ganymedeRadiationAmount;
    }

    @Override
    public int getPressureLevel() {
        return com.mjr.extraplanets.Config.ganymedePressureAmount;
    }
}
