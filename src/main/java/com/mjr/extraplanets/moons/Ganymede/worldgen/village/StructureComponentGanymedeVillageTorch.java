...
public class StructureComponentGanymedeVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentGanymedeVillageTorch() {}

    public StructureComponentGanymedeVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
