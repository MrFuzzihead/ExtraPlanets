...
public class StructureVillagePieceWeightGanymede extends StructureVillagePieceWeight {

    public StructureVillagePieceWeightGanymede(Class<? extends StructureComponentVillage> par1Class, int par2,
        int par3) {
