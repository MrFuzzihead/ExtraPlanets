...
public class StructureComponentGanymedeVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentGanymedeVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.ganymedeBlocks;
    }

    public StructureComponentGanymedeVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentGanymedeVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentGanymedeVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
