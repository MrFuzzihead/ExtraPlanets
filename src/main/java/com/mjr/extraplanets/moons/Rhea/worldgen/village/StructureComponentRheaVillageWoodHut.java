...
public class StructureComponentRheaVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentRheaVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.rheaBlocks;
    }

    public StructureComponentRheaVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentRheaVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentRheaVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
