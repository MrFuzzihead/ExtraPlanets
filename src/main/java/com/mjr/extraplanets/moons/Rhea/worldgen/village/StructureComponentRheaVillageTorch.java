...
public class StructureComponentRheaVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentRheaVillageTorch() {}

    public StructureComponentRheaVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
