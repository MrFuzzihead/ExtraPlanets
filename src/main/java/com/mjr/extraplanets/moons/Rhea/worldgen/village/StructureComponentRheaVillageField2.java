...
public class StructureComponentRheaVillageField2 extends StructureComponentRheaVillage {
    ...
    public StructureComponentRheaVillageField2(StructureComponentRheaVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentRheaVillageField2 func_74900_a(
        StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentRheaVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentRheaVillageField2(
