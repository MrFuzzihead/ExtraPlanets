...
public class StructureVillageStartRhea extends StructureStart {
    ...
    public StructureVillageStartRhea(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightRhea> var6 = StructureVillagePiecesRhea
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentRheaVillageStartPiece var7 = new StructureComponentRheaVillageStartPiece(
