...
public class StructureVillagePiecesRhea {
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightRhea> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightRhea> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentRheaVillage func_75083_a(
        StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightRhea par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentRheaVillageWoodHut.class) {
            var10 = StructureComponentRheaVillageWoodHut
            ...
            var10 = StructureComponentRheaVillageField
            ...
            var10 = StructureComponentRheaVillageHouse
    ...
    private static StructureComponentRheaVillage getNextVillageComponent(
        StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesRhea
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightRhea> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentRheaVillage var13 = StructureVillagePiecesRhea.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentRheaVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentRheaVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentRheaVillage var8 = StructureVillagePiecesRhea.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentRheaVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentRheaVillagePathGen var9 = new StructureComponentRheaVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesRhea.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentRheaVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesRhea.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
