...
public class StructureComponentRheaVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentRheaVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.rheaBlocks;
    }

    public StructureComponentRheaVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentRheaVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentRheaVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
