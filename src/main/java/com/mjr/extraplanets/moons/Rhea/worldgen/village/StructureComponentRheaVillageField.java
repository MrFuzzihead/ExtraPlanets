...
public class StructureComponentRheaVillageField extends StructureComponentRheaVillage {
    ...
    public StructureComponentRheaVillageField(StructureComponentRheaVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentRheaVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentRheaVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
