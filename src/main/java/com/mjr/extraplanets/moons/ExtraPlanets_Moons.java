...
public class ExtraPlanets_Moons {
    ...
    public static void initializeUnReachableMoons() {
        if (Config.generateUnreachableMoons) {
            ...
            if (ExtraPlanets_Planets.pluto != null) {
                ...
                if (charon != null) charon.setRingColorRGB(0.1F, 0.9F, 0.6F)
                    .setPhaseShift(1.45F)
                    .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(9F, 9F))
                    .setRelativeOrbitTime(25.5785754286855436F);

                nix = RegisterHelper.registerUnreachableMoon("nix", ExtraPlanets_Planets.pluto);
                if (nix != null) nix.setRingColorRGB(0.1F, 0.9F, 0.6F)
                    .setPhaseShift(1.45F)
                    .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(18F, 18F))
                    .setRelativeOrbitTime(57.415456589452485548F);

                hydra = RegisterHelper.registerUnreachableMoon("hydra", ExtraPlanets_Planets.pluto);
                if (hydra != null) hydra.setRingColorRGB(0.1F, 0.9F, 0.6F)
                    .setPhaseShift(1.45F)
                    .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(27F, 27F))
                    .setRelativeOrbitTime(123.252594612756974F);
            }
            if (ExtraPlanets_Planets.eris != null) {
                // Eris Moons
                dysnomia = RegisterHelper.registerUnreachableMoon("dysnomia", ExtraPlanets_Planets.eris);
                if (dysnomia != null) dysnomia.setRingColorRGB(0.1F, 0.9F, 0.6F)
                    .setPhaseShift(1.45F)
                    .setRelativeDistanceFromCenter(new CelestialBody.ScalableDistance(9F, 9F))
                    .setRelativeOrbitTime(25.5785754286855436F);
            }
    ...
    private static void initializeMoons() {
        if (Config.triton) {
            ...
            triton.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            triton.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/triton.png"));
        ...
        if (Config.phobos) {
            ...
            phobos.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            phobos.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/phobos.png"));
        ...
        if (Config.deimos) {
            ...
            deimos.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            deimos.setBodyIcon(
                new ResourceLocation(Constants.TEXTURE_PREFIX + "textures/gui/celestialbodies/deimos.png"));
        ...
        if (Config.io) {
            ...
            io.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
        ...
        if (Config.europa) {
            ...
            europa.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            europa.setBodyIcon(
                new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/celestialbodies/europa.png"));
            europa.setDimensionInfo(Config.europaID, WorldProviderEuropa.class);
        }

        if (Config.ganymede) {
            ganymede = new Moon(ganymedeOverride ? "ganymedeEP" : "ganymede")
                .setParentPlanet(ExtraPlanets_Planets.jupiter);
            ...
            ganymede.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            ganymede.setBodyIcon(
                new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/celestialbodies/ganymede.png"));
            ganymede.setDimensionInfo(Config.ganymedeID, WorldProviderGanymede.class);
        }
        if (Config.callisto) {
            callisto = new Moon(callistoOverride ? "callistoEP" : "callisto")
                .setParentPlanet(ExtraPlanets_Planets.jupiter);
            ...
            callisto.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            callisto.setBodyIcon(
                new ResourceLocation(GalacticraftCore.ASSET_PREFIX, "textures/gui/celestialbodies/callisto.png"));
        ...
        if (Config.rhea) {
            ...
            rhea.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
        ...
        if (Config.titan) {
            ...
            titan.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
        ...
        if (Config.oberon) {
            ...
            oberon.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
        ...
        if (Config.titania) {
            ...
            titania.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            titania
                .setBodyIcon(new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/titania.png"));
        ...
        if (Config.iapetus) {
            ...
            iapetus.atmosphereComponent(IAtmosphericGas.HYDROGEN)
                .atmosphereComponent(IAtmosphericGas.HELIUM)
                .atmosphereComponent(IAtmosphericGas.METHANE);
            iapetus
                .setBodyIcon(new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/celestialbodies/iapetus.png"));
    ...
    private static void registerMoons() {
        if (Config.triton) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderTriton.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/triton_rocket_gui.png"));
        }
        if (Config.europa) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderEuropa.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/europa_rocket_gui.png"));
        }
        if (Config.io) {
            GalaxyRegistry.registerMoon(io);
            GalacticraftRegistry.registerTeleportType(WorldProviderIo.class, new TeleportTypeIo());
            GalacticraftRegistry.registerRocketGui(
                WorldProviderIo.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/io_rocket_gui.png"));
        }
        if (Config.deimos) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderDeimos.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/deimos_rocket_gui.png"));
        }
        if (Config.phobos) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderPhobos.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/phobos_rocket_gui.png"));
        }
        if (Config.callisto) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderCallisto.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/callisto_rocket_gui.png"));
        }
        if (Config.ganymede) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderGanymede.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/ganymede_rocket_gui.png"));
        }
        if (Config.rhea) {
            GalaxyRegistry.registerMoon(rhea);
            GalacticraftRegistry.registerTeleportType(WorldProviderRhea.class, new TeleportTypeRhea());
            GalacticraftRegistry.registerRocketGui(
                WorldProviderRhea.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/rhea_rocket_gui.png"));
        }
        if (Config.titan) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderTitan.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/titan_rocket_gui.png"));
        }
        if (Config.oberon) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderOberon.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/oberon_rocket_gui.png"));
        }
        if (Config.titania) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderTitania.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/titania_rocket_gui.png"));
        }
        if (Config.iapetus) {
            ...
            GalacticraftRegistry.registerRocketGui(
                WorldProviderIapetus.class,
                new ResourceLocation(Constants.ASSET_PREFIX, "textures/gui/iapetus_rocket_gui.png"));
        }
    }
}
