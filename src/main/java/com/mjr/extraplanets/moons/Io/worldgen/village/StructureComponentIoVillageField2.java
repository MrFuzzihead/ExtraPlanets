...
public class StructureComponentIoVillageField2 extends StructureComponentIoVillage {
    ...
    public StructureComponentIoVillageField2(StructureComponentIoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIoVillageField2 func_74900_a(
        StructureComponentIoVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentIoVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentIoVillageField2(
