...
public class StructureComponentIoVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentIoVillageTorch() {}

    public StructureComponentIoVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
