...
public class StructureVillageStartIo extends StructureStart {
    ...
    public StructureVillageStartIo(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightIo> var6 = StructureVillagePiecesIo
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentIoVillageStartPiece var7 = new StructureComponentIoVillageStartPiece(
