...
public class StructureComponentIoVillageStartPiece extends StructureComponentVillageStartPiece {

    public StructureComponentIoVillageStartPiece() {
        this.planetBlock = ExtraPlanets_Blocks.ioBlocks;
    }

    @SuppressWarnings({ "rawtypes", "unchecked" })
    public StructureComponentIoVillageStartPiece(WorldChunkManager par1WorldChunkManager, int par2, Random par3Random,
        int par4, int par5, ArrayList<StructureVillagePieceWeightIo> par6ArrayList, int par7) {
    ...
    public StructureComponentVillageTorch constructTorch(int par1, Random par2Random,
        ...
        return new StructureComponentIoVillageTorch(this, par1, par2Random, par3StructureBoundingBox, par4);
    }

    @Override
    public StructureComponentVillagePathGen constructPath(int par1, Random par2Random,
        StructureBoundingBox par3StructureBoundingBox, int par4) {
        return new StructureComponentIoVillagePathGen(this, par1, par2Random, par3StructureBoundingBox, par4);
    }
}
