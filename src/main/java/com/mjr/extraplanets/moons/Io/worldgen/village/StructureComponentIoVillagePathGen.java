...
public class StructureComponentIoVillagePathGen extends StructureComponentVillagePathGen {

    public StructureComponentIoVillagePathGen() {}

    public StructureComponentIoVillagePathGen(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
