...
public class StructureComponentIoVillageWoodHut extends StructureComponentIoVillage {
    ...
    public StructureComponentIoVillageWoodHut(StructureComponentIoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public boolean addComponentParts(World par1World, Random par2Random,
        ...
        for (yLevel = -8; yLevel < 4; yLevel++) {
            ...
            this.placeBlockAtCurrentPosition(
                par1World,
                yLevel <= 1 ? ExtraPlanets_Blocks.ioBlocks : Blocks.air,
                1,
                1,
                yLevel,
                8,
