...
public class StructureComponentIoVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentIoVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.ioBlocks;
    }

    public StructureComponentIoVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIoVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentIoVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
