...
public class StructureComponentIoVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentIoVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.ioBlocks;
    }

    public StructureComponentIoVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIoVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentIoVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
