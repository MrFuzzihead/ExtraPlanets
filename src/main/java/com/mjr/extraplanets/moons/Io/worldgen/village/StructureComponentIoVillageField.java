...
public class StructureComponentIoVillageField extends StructureComponentIoVillage {
    ...
    public StructureComponentIoVillageField(StructureComponentIoVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIoVillageField func_74900_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentIoVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
