...
public class StructureComponentIoVillageField extends StructureComponentVillageField {

    public StructureComponentIoVillageField() {}

    public StructureComponentIoVillageField(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
