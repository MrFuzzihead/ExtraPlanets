...
public class StructureComponentOberonVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentOberonVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.oberonBlocks;
    }

    public StructureComponentOberonVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentOberonVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentOberonVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
