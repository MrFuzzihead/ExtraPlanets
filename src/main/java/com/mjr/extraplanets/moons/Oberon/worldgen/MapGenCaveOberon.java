                                ...
                                for (int localZ = l2; localZ < i3; localZ++) {
                                    ...
                                    if (xfactorSq + zfactorSq < 1.0D) {
                                        ...
                                        if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                            if (((blockIdArray[coords] == dirtblock) && (metaArray[coords] == 1))
                                                || ((blockIdArray[coords] == stoneblock) && (metaArray[coords] == 2))) {
                                                blockIdArray[coords] = Blocks.air;
                                            } else if ((blockIdArray[coords] == grassblock) && (metaArray[coords] == 0)
