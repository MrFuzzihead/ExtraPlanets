...
public class StructureComponentOberonVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentOberonVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.oberonBlocks;
    }

    public StructureComponentOberonVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentOberonVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentOberonVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
