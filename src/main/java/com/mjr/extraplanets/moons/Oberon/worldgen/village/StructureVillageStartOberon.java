...
public class StructureVillageStartOberon extends StructureStart {
    ...
    public StructureVillageStartOberon(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightOberon> var6 = StructureVillagePiecesOberon
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentOberonVillageStartPiece var7 = new StructureComponentOberonVillageStartPiece(
