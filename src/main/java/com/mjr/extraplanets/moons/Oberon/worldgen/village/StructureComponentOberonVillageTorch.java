...
public class StructureComponentOberonVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentOberonVillageTorch() {}

    public StructureComponentOberonVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
