...
public class StructureComponentOberonVillageField2 extends StructureComponentOberonVillage {
    ...
    public StructureComponentOberonVillageField2(
        StructureComponentOberonVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentOberonVillageField2 func_74900_a(
        StructureComponentOberonVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentOberonVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentOberonVillageField2(
