...
public class StructureComponentCallistoVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentCallistoVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.callistoBlocks;
    }

    public StructureComponentCallistoVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCallistoVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentCallistoVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
