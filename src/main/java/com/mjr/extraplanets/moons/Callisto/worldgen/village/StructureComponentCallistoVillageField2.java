...
public class StructureComponentCallistoVillageField2 extends StructureComponentCallistoVillage {
    ...
    public StructureComponentCallistoVillageField2(
        StructureComponentCallistoVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentCallistoVillageField2 func_74900_a(
        StructureComponentCallistoVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentCallistoVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentCallistoVillageField2(
