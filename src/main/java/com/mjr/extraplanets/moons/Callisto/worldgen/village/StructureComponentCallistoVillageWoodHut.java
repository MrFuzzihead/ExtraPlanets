...
public class StructureComponentCallistoVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentCallistoVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.callistoBlocks;
    }

    public StructureComponentCallistoVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentCallistoVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentCallistoVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
