...
public class StructureVillageStartCallisto extends StructureStart {
    ...
    public StructureVillageStartCallisto(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        final ArrayList<StructureVillagePieceWeightCallisto> var6 = StructureVillagePiecesCallisto
            .getStructureVillageWeightedPieceList(par2Random, par5);
        final StructureComponentCallistoVillageStartPiece var7 = new StructureComponentCallistoVillageStartPiece(
