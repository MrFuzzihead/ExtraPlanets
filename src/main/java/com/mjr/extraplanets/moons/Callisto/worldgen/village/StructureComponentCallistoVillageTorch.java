...
public class StructureComponentCallistoVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentCallistoVillageTorch() {}

    public StructureComponentCallistoVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
