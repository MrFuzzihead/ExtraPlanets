...
public abstract class StructureComponentCallistoVillage extends StructureComponent {
    ...
    protected StructureComponentCallistoVillage(
    ...
    protected StructureComponent getNextComponentNN(
        StructureComponentCallistoVillageStartPiece par1ComponentVillageStartPiece, List par2List, Random par3Random,
        int par4, int par5) {
        switch (this.coordBaseMode) {
            case 0:
                return StructureVillagePiecesCallisto.getNextStructureComponent(
