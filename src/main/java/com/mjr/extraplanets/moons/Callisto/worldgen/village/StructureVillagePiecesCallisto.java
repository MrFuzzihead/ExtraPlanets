...
public class StructureVillagePiecesCallisto {
    ...
    public static ArrayList<StructureVillagePieceWeightCallisto> getStructureVillageWeightedPieceList(Random par0Random,
        int par1) {
        final ArrayList<StructureVillagePieceWeightCallisto> var2 = new ArrayList<StructureVillagePieceWeightCallisto>();
        var2.add(
            new StructureVillagePieceWeightCallisto(
                StructureComponentCallistoVillageWoodHut.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 2 + par1, 5 + par1 * 3)));
        var2.add(
            new StructureVillagePieceWeightCallisto(
                StructureComponentCallistoVillageField.class,
                5,
                MathHelper.getRandomIntegerInRange(par0Random, 3 + par1, 5 + par1)));
        var2.add(
            new StructureVillagePieceWeightCallisto(
                StructureComponentCallistoVillageHouse.class,
                5,
    ...
    private static int func_75079_a(List<StructureVillagePieceWeightCallisto> par0List) {
        ...
        for (final Iterator<StructureVillagePieceWeightCallisto> var3 = par0List.iterator(); var3
    ...
    private static StructureComponentCallistoVillage func_75083_a(
        StructureComponentCallistoVillageStartPiece par0ComponentVillageStartPiece,
        StructureVillagePieceWeightCallisto par1StructureVillagePieceWeight, List<StructureComponent> par2List,
        ...
        if (var9 == StructureComponentCallistoVillageWoodHut.class) {
            var10 = StructureComponentCallistoVillageWoodHut
            ...
            var10 = StructureComponentCallistoVillageField
            ...
            var10 = StructureComponentCallistoVillageHouse
    ...
    private static StructureComponentCallistoVillage getNextVillageComponent(
        StructureComponentCallistoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        final int var8 = StructureVillagePiecesCallisto
        ...
        if (var8 <= 0) {
            ...
            while (var9 < 5) {
                ...
                final Iterator<StructureVillagePieceWeightCallisto> var11 = par0ComponentVillageStartPiece.structureVillageWeightedPieceList
                    .iterator();
                ...
                while (var11.hasNext()) {
                    ...
                    if (var10 < 0) {
                        ...
                        final StructureComponentCallistoVillage var13 = StructureVillagePiecesCallisto.func_75083_a(
            ...
            final StructureBoundingBox var14 = StructureComponentCallistoVillageTorch
                .func_74904_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

            if (var14 != null) {
                return new StructureComponentCallistoVillageTorch(
                    par0ComponentVillageStartPiece,
                    par7,
                    par2Random,
                    var14,
    ...
    private static StructureComponent getNextVillageStructureComponent(
        ...
        if (par7 > 50) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureComponentCallistoVillage var8 = StructureVillagePiecesCallisto.getNextVillageComponent(
                    par0ComponentVillageStartPiece,
                    par1List,
                    par2Random,
                    par3,
    ...
    private static StructureComponent getNextComponentVillagePath(
        ...
        if (par7 > 3 + par0ComponentVillageStartPiece.terrainType) {
            ...
            && Math.abs(par5 - par0ComponentVillageStartPiece.getBoundingBox().minZ) <= 112) {
                final StructureBoundingBox var8 = StructureComponentCallistoVillagePathGen
                    .func_74933_a(par0ComponentVillageStartPiece, par1List, par2Random, par3, par4, par5, par6);

                if (var8 != null && var8.minY > 10) {
                    final StructureComponentCallistoVillagePathGen var9 = new StructureComponentCallistoVillagePathGen(
                        par0ComponentVillageStartPiece,
                        par7,
                        par2Random,
                        var8,
    ...
    static StructureComponent getNextStructureComponent(
        StructureComponentCallistoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesCallisto.getNextVillageStructureComponent(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
    ...
    static StructureComponent getNextStructureComponentVillagePath(
        StructureComponentCallistoVillageStartPiece par0ComponentVillageStartPiece, List<StructureComponent> par1List,
        Random par2Random, int par3, int par4, int par5, int par6, int par7) {
        return StructureVillagePiecesCallisto.getNextComponentVillagePath(
            par0ComponentVillageStartPiece,
            par1List,
            par2Random,
            par3,
