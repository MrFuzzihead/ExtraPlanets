...
public class StructureComponentIapetusVillageTorch extends StructureComponentVillageTorch {

    public StructureComponentIapetusVillageTorch() {}

    public StructureComponentIapetusVillageTorch(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
