...
public class StructureComponentIapetusVillageField2 extends StructureComponentIapetusVillage {
    ...
    public StructureComponentIapetusVillageField2(
        StructureComponentIapetusVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    public static StructureComponentIapetusVillageField2 func_74900_a(
        StructureComponentIapetusVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random,
        ...
        return StructureComponentIapetusVillage.canVillageGoDeeper(structureboundingbox)
            && StructureComponent.findIntersecting(par1List, structureboundingbox) == null
                ? new StructureComponentIapetusVillageField2(
