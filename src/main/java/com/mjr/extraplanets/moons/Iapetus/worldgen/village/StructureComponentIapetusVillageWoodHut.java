...
public class StructureComponentIapetusVillageWoodHut extends StructureComponentVillageWoodHut {

    public StructureComponentIapetusVillageWoodHut() {
        this.planetBlock = ExtraPlanets_Blocks.iapetusBlocks;
    }

    public StructureComponentIapetusVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIapetusVillageWoodHut func_74908_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentIapetusVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
