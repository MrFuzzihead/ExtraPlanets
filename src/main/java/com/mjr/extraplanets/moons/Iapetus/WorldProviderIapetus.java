...
public class WorldProviderIapetus extends WorldProviderSpace
    ...
    public float getFallDamageModifier() {
        if (Config.oldStyleGravity) return 0.38F;
        else return 2.1F;
    }
    ...
    public int getSolarRadiationLevel() {
        return com.mjr.extraplanets.Config.iapetusRadiationAmount;
    }

    @Override
    public int getPressureLevel() {
        return com.mjr.extraplanets.Config.iapetusPressureAmount;
    }
}
