...
public class StructureComponentIapetusVillageHouse extends StructureComponentVillageHouse {

    public StructureComponentIapetusVillageHouse() {
        this.planetBlock = ExtraPlanets_Blocks.iapetusBlocks;
    }

    public StructureComponentIapetusVillageHouse(StructureComponentVillageStartPiece par1ComponentVillageStartPiece,
    ...
    public static StructureComponentIapetusVillageHouse func_74921_a(
        ...
        return StructureComponent.findIntersecting(par1List, var8) == null
            ? new StructureComponentIapetusVillageHouse(par0ComponentVillageStartPiece, par7, par2Random, var8, par6)
            : null;
    }
}
