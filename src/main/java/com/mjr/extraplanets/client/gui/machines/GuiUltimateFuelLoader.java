...
public class GuiUltimateFuelLoader extends GuiContainerGC {
    ...
    public GuiUltimateFuelLoader(InventoryPlayer par1InventoryPlayer,
        TileEntityUltimateFuelLoader par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiUltimateFuelLoader.fuelLoaderTexture);
