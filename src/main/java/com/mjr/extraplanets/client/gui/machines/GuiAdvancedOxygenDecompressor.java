...
public class GuiAdvancedOxygenDecompressor extends GuiContainerGC {
    ...
    public GuiAdvancedOxygenDecompressor(InventoryPlayer par1InventoryPlayer,
        TileEntityAdvancedOxygenDecompressor par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        status = GCCoreUtil.translate("gui.maxOutput.desc") + ": "
            + TileEntityAdvancedOxygenDecompressor.OUTPUT_PER_TICK * 20
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiAdvancedOxygenDecompressor.compressorTexture);
