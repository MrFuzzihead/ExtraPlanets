...
public class GuiAdvancedFuelLoader extends GuiContainerGC {
    ...
    public GuiAdvancedFuelLoader(InventoryPlayer par1InventoryPlayer,
        TileEntityAdvancedFuelLoader par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiAdvancedFuelLoader.fuelLoaderTexture);
