...
public class GuiAdvancedOxygenCompressor extends GuiContainerGC {
    ...
    public GuiAdvancedOxygenCompressor(InventoryPlayer par1InventoryPlayer,
        TileEntityAdvancedOxygenCompressor par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        status = GCCoreUtil.translate("gui.oxygenUse.desc") + ": "
            + TileEntityAdvancedOxygenCompressor.TANK_TRANSFER_SPEED * 20
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiAdvancedOxygenCompressor.compressorTexture);
