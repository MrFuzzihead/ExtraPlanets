...
public class GuiVehicleBase extends GuiContainerGC {
    ...
    static {
        for (int i = 0; i < 4; i++) {
            GuiVehicleBase.sealerTexture[i] = new ResourceLocation(
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (this.mc.thePlayer != null && this.mc.thePlayer.ridingEntity != null
            && this.mc.thePlayer.ridingEntity instanceof EntityVehicleBase) {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        this.mc.getTextureManager()
            .bindTexture(GuiVehicleBase.sealerTexture[this.type]);
