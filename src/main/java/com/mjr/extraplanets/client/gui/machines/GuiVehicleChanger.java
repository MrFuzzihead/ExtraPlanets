...
public class GuiVehicleChanger extends GuiContainerGC {
    ...
    private static final ResourceLocation vehicleChangerTexture = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/gui/vehicle_charger.png");
    ...
    public GuiVehicleChanger(InventoryPlayer par1InventoryPlayer,
        TileEntityVehicleChanger par2TileEntityAirDistributor) {
            ...
            case 0:
                GalacticraftCore.packetPipeline.sendToServer(
                    new PacketSimple(
                        ...
                        new Object[] { this.vehicleChanger.xCoord, this.vehicleChanger.yCoord,
                            this.vehicleChanger.zCoord, 0 }));
                break;
        }
    }
    ...
    public void initGui() {
        ...
        electricityDesc.add(
            EnumColor.YELLOW + GCCoreUtil.translate("gui.energyStorage.desc.1")
                + ((int) Math.floor(this.vehicleChanger.getEnergyStoredGC()) + " / "
                    + (int) Math.floor(this.vehicleChanger.getMaxEnergyStoredGC())));
        ...
        this.buttonList.add(
            this.buttonloadpower = new GuiButton(
                0,
                this.width / 2 + 2,
                this.height / 2 - 49,
                76,
                20,
                GCCoreUtil.translate("gui.button.loadpower.name")));
    }

    @Override
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        this.fontRendererObj.drawString(this.vehicleChanger.getInventoryName(), 52, 10, 4210752);
        this.buttonloadpower.displayString = !this.vehicleChanger.getDisabled(0)
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiVehicleChanger.vehicleChangerTexture);
        ...
        EnergyDisplayHelper.getEnergyDisplayTooltip(
            this.vehicleChanger.getEnergyStoredGC(),
            this.vehicleChanger.getMaxEnergyStoredGC(),
            electricityDesc);
        this.electricInfoRegion.tooltipStrings = electricityDesc;
        ...
        this.drawTexturedModalRect(
            ...
            192,
            0,
            Math.min(this.vehicleChanger.getScaledElecticalLevel(54), 54),
            7);
    }
}
