...
public class GuiUltimateOxygenDecompressor extends GuiContainerGC {
    ...
    public GuiUltimateOxygenDecompressor(InventoryPlayer par1InventoryPlayer,
        TileEntityUltimateOxygenDecompressor par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        status = GCCoreUtil.translate("gui.maxOutput.desc") + ": "
            + TileEntityUltimateOxygenDecompressor.OUTPUT_PER_TICK * 20
        ...
        // this.fontRendererObj.drawString(status, this.xSize / 2 - this.fontRendererObj.getStringWidth(status) / 2, 70,
        // 4210752);
        // status = ElectricityDisplay.getDisplay(this.decompressor.getVoltage(), ElectricUnit.VOLTAGE);
        // this.fontRendererObj.drawString(status, this.xSize / 2 - this.fontRendererObj.getStringWidth(status) / 2, 80,
        // 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiUltimateOxygenDecompressor.compressorTexture);
