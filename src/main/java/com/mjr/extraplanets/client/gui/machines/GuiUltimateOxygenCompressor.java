...
public class GuiUltimateOxygenCompressor extends GuiContainerGC {
    ...
    public GuiUltimateOxygenCompressor(InventoryPlayer par1InventoryPlayer,
        TileEntityUltimateOxygenCompressor par2TileEntityAirDistributor) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        status = GCCoreUtil.translate("gui.oxygenUse.desc") + ": "
            + TileEntityUltimateOxygenCompressor.TANK_TRANSFER_SPEED * 20
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        this.mc.getTextureManager()
            .bindTexture(GuiUltimateOxygenCompressor.compressorTexture);
