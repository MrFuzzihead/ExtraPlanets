...
public class ModelEvolvedWitch extends ModelVillager {
    ...
    public ModelEvolvedWitch(float p_i1166_1_) {
        ...
        this.field_82901_h.setTextureOffset(0, 0)
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
        ...
        this.villagerNose.rotateAngleX = MathHelper.sin(p_78087_7_.ticksExisted * f6) * 4.5F
            * Constants.floatPI
            / 180.0F;
        this.villagerNose.rotateAngleY = 0.0F;
        this.villagerNose.rotateAngleZ = MathHelper.cos(p_78087_7_.ticksExisted * f6) * 2.5F
            * Constants.floatPI
            / 180.0F;
