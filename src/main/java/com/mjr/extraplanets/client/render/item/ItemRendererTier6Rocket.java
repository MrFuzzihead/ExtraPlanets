...
public class ItemRendererTier6Rocket implements IItemRenderer {
    ...
    protected ResourceLocation texture2 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_white.png");
    protected ResourceLocation texture3 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_grey.png");
    protected ResourceLocation texture4 = new ResourceLocation(
        Constants.ASSET_PREFIX,
    ...
    protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX,
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(texture4);
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(texture3);
        ...
        FMLClientHandler.instance()
            .getClient().renderEngine.bindTexture(texture2);
        ...
        if (type == ItemRenderType.INVENTORY) {
            ...
            if (EnumRocketType.values()[index].getInventorySpace() > 3) {
                ...
                FMLClientHandler.instance()
                    .getClient().renderEngine.bindTexture(ItemRendererTier6Rocket.chestTexture);
