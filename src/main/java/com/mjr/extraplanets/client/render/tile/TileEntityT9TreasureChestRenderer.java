...
public class TileEntityT9TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderGCTileEntityTreasureChestAt(TileEntityT9TreasureChest par1GCTileEntityTreasureChest, double par2,
        ...
        if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
            ...
            if (var10 != null && var9 == 0) {
                ((T9TreasureChest) var10).unifyAdjacentChests(
