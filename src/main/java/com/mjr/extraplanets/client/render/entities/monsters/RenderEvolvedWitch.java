...
public class RenderEvolvedWitch extends RenderLiving {
    ...
    private static final ResourceLocation witchTextures = new ResourceLocation(
        Constants.TEXTURE_PREFIX + "textures/entity/evolved_witch.png");
     ...
     */
    public void doRender(EntityEvolvedWitch p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
