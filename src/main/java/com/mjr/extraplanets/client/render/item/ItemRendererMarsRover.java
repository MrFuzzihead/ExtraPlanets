...
public class ItemRendererMarsRover implements IItemRenderer {
    ...
    private static final ResourceLocation buggyTextureBody = new ResourceLocation(
        ...
        "textures/model/blank_rocket_dark_grey.png");
    private static final ResourceLocation buggyTextureWheel = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_black.png");
    private static final ResourceLocation buggyTextureStorage = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket.png");
    private static final ResourceLocation buggyTextureOther = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_white.png");
    private static final ResourceLocation buggyTextureOther2 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_orange_textured.png");
    private static final ResourceLocation buggyTextureOther3 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_textured.png");
    private static final ResourceLocation buggyTextureOther4 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_light_blue_textured.png");
    private static final ResourceLocation buggyTextureOther5 = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_blue_textured.png");
    private static final ResourceLocation buggyTextureBatteryBolt = new ResourceLocation(
        Constants.ASSET_PREFIX,
        "textures/model/blank_rocket_yellow.png");

    EntityMarsRover spaceship = new EntityMarsRover(
        FMLClientHandler.instance()
            .getClient().theWorld);

    private final IModelCustom modelRover;
    private final IModelCustom modelRoverWheelLeft = AdvancedModelLoader
        .loadModel(new ResourceLocation(Constants.ASSET_PREFIX, "models/MarsRover-Wheel.obj"));
    private final IModelCustom modelRoverWheelRight = AdvancedModelLoader
        .loadModel(new ResourceLocation(Constants.ASSET_PREFIX, "models/MarsRover-Wheel.obj"));
    ...
    private void renderPipeItem(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX,
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureWheel);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureBody);
        this.modelRover.renderPart("RoofRover");
        this.modelRover.renderPart("FloorRover");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureOther2);
        this.modelRover.renderPart("Clip1");
        this.modelRover.renderPart("Clip2");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureStorage);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureOther);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureOther4);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureOther3);
        this.modelRover.renderPart("Wire");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureOther5);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(new ResourceLocation(Constants.ASSET_PREFIX, "textures/model/solar_panel.png"));
        this.modelRover.renderPart("SolarPlane");

        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererMarsRover.buggyTextureBatteryBolt);
