...
public class RenderEvolvedIceBlaze extends RenderLiving {
    ...
    private static final ResourceLocation blazeTextures = new ResourceLocation(
        Constants.TEXTURE_PREFIX + "textures/entity/ice_blaze.png");
     ...
     */
    public void doRender(EntityEvolvedIceBlaze p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
