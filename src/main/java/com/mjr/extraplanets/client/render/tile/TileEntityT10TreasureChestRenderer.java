...
public class TileEntityT10TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderGCTileEntityTreasureChestAt(TileEntityT10TreasureChest par1GCTileEntityTreasureChest, double par2,
        ...
        if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
            ...
            if (var10 != null && var9 == 0) {
                ((T10TreasureChest) var10).unifyAdjacentChests(
