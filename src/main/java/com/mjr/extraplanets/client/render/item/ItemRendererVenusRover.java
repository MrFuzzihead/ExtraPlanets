...
public class ItemRendererVenusRover implements IItemRenderer {
    ...
    EntityVenusRover spaceship = new EntityVenusRover(
        FMLClientHandler.instance()
            .getClient().theWorld);

    private final IModelCustom modelRover;
    private final IModelCustom modelRoverWheelLeft = AdvancedModelLoader
        .loadModel(new ResourceLocation(Constants.ASSET_PREFIX, "models/VenusRover-Wheels.obj"));
    ...
    private void renderPipeItem(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX,
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureWheel);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureOther5);
        this.modelRover.renderPart("Battery");
        this.modelRover.renderPart("Battery2");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureStorage);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureOther2);
        this.modelRover.renderPart("Clip1");
        this.modelRover.renderPart("Clip2");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureBody);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureOther4);
        this.modelRover.renderPart("RTG");
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureOther);
        ...
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(ItemRendererVenusRover.buggyTextureBatteryBolt);
