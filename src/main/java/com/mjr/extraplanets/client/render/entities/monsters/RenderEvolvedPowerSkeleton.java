...
public class RenderEvolvedPowerSkeleton extends RenderBiped {
    ...
    public RenderEvolvedPowerSkeleton() {
        ...
        try {
            ...
            RenderEvolvedPowerSkeleton.isBG2Loaded = clazz.getField("Skell_Arrow_Datawatcher")
                .getInt(null);
        } catch (Exception e) {}
    }
    ...
    protected void renderEquippedItems(EntityLivingBase par1EntityLiving, float par2) {
        if (RenderEvolvedPowerSkeleton.isBG2Loaded > 0) {
            if (par1EntityLiving.getDataWatcher()
                .getWatchableObjectInt(RenderEvolvedPowerSkeleton.isBG2Loaded) == 0) {
                par1EntityLiving.getDataWatcher()
                    .addObject(RenderEvolvedPowerSkeleton.isBG2Loaded, (byte) -1);
            }
        }
