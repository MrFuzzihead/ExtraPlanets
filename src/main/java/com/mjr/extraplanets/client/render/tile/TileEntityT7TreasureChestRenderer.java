...
public class TileEntityT7TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderGCTileEntityTreasureChestAt(TileEntityT7TreasureChest par1GCTileEntityTreasureChest, double par2,
        ...
        if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
            ...
            if (var10 != null && var9 == 0) {
                ((T7TreasureChest) var10).unifyAdjacentChests(
