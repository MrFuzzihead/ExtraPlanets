...
public class TileEntityT8TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderGCTileEntityTreasureChestAt(TileEntityT8TreasureChest par1GCTileEntityTreasureChest, double par2,
        ...
        if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
            ...
            if (var10 != null && var9 == 0) {
                ((T8TreasureChest) var10).unifyAdjacentChests(
