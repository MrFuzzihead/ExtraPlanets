...
public class RenderEvolvedFireBatBoss extends RenderLiving {
     ...
     * (Render<T extends
     * Entity) and this method has signature public void func_76986_a(T entity, double d, double d1, double d2, float f,
     * float f1). But JAD is pre 1.5 so doesn't do that.
     */
    public void doRender(EntityEvolvedFireBatBoss p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
     ...
     */
    protected void renderLivingAt(EntityEvolvedFireBatBoss p_77039_1_, double p_77039_2_, double p_77039_4_,
        double p_77039_6_) {
        super.renderLivingAt(p_77039_1_, p_77039_2_, p_77039_4_, p_77039_6_);
    }

    protected void rotateCorpse(EntityEvolvedFireBatBoss p_77043_1_, float p_77043_2_, float p_77043_3_,
        float p_77043_4_) {
    ...
    public void doRender(EntityLiving p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        float p_76986_8_, float p_76986_9_) {
        this.doRender(
            (EntityEvolvedFireBatBoss) p_76986_1_,
            p_76986_2_,
            p_76986_4_,
            p_76986_6_,
            p_76986_8_,
