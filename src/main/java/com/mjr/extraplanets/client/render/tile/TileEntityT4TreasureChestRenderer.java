...
public class TileEntityT4TreasureChestRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderGCTileEntityTreasureChestAt(TileEntityT4TreasureChest par1GCTileEntityTreasureChest, double par2,
        ...
        if (!par1GCTileEntityTreasureChest.hasWorldObj()) {
            ...
            if (var10 != null && var9 == 0) {
                ((T4TreasureChest) var10).unifyAdjacentChests(
