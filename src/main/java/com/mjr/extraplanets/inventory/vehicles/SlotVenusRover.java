...
public class SlotVenusRover extends Slot {
    ...
    public SlotVenusRover(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z,
        EntityPlayer player) {
    ...
    public boolean isItemValid(ItemStack par1ItemStack) {
        switch (this.index) {
            ...
            case 15:
                return par1ItemStack.getItem() == ExtraPlanets_Items.tier4Items && par1ItemStack.getItemDamage() == 3;
            case 16:
                return par1ItemStack.getItem() == ExtraPlanets_Items.electricParts
                    && par1ItemStack.getItemDamage() == 4;
            case 17:
                return par1ItemStack.getItem() == ExtraPlanets_Items.electricParts
