...
public class BlockNuclearBomb extends Block {
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_,
        ...
        if (!p_149723_1_.isRemote) {
            EntityNuclearBombPrimed entitynuclearBombprimed = new EntityNuclearBombPrimed(
                p_149723_1_,
                p_149723_2_ + 0.5F,
                p_149723_3_ + 0.5F,
                p_149723_4_ + 0.5F,
                p_149723_5_.getExplosivePlacedBy());
            entitynuclearBombprimed.fuse = p_149723_1_.rand.nextInt(entitynuclearBombprimed.fuse / 4)
                + entitynuclearBombprimed.fuse / 8;
    ...
    public void primeTnt(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_,
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
        ...
        if (p_149727_5_.getCurrentEquippedItem() != null && p_149727_5_.getCurrentEquippedItem()
            .getItem() == Items.flint_and_steel) {
            this.primeTnt(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_, 1, p_149727_5_);
            p_149727_1_.setBlockToAir(p_149727_2_, p_149727_3_, p_149727_4_);
            p_149727_5_.getCurrentEquippedItem()
                .damageItem(1, p_149727_5_);
            return true;
        } else {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon(
            Constants.TEXTURE_PREFIX + this.getUnlocalizedName()
                .substring(5) + "_side");
        this.field_150116_a = p_149651_1_.registerIcon(
            Constants.TEXTURE_PREFIX + this.getUnlocalizedName()
                .substring(5) + "_top");
        this.field_150115_b = p_149651_1_.registerIcon(
            Constants.TEXTURE_PREFIX + this.getUnlocalizedName()
                .substring(5) + "_bottom");
    }
}
