...
public class BlockCustomLandingPad extends BlockAdvancedTile
    implements IPartialSealableBlock, ItemBlockDesc.IBlockShiftDesc {
    ...
    public boolean canPlaceBlockOnSide(World par1World, int par2, int par3, int par4, int par5) {
        ...
        if (par1World.getBlock(par2 + 1, par3, par4) == id && par1World.getBlock(par2 + 4, par3, par4) == id
        ...
        if (par1World.getBlock(par2, par3, par4 + 1) == id && par1World.getBlock(par2, par3, par4 + 4) == id
    ...
    public String getShiftDescription(int meta) {
        if (meta == 0) return GCCoreUtil.translate(this.getUnlocalizedName() + ".tier2.desc");
        else if (meta == 1) return GCCoreUtil.translate(this.getUnlocalizedName() + ".tier3.desc");
        else if (meta == 2) return GCCoreUtil.translate(this.getUnlocalizedName() + ".powered.desc");
        else return "";
    }
