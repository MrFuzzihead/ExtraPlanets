...
public class ExtraPlanets_SlabsStairsBlocks {
    ...
    private static void initializeSlabsAndStairsBlocks() {
        if (Config.mercury) {
            mercuryStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "mercuryStoneBlockhalfslab",
                "mercury_stone");
            ...
            mercuryStoneBrickStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.mercuryBlocks,
                7,
                "mercuryStoneBrickStairs");
        }
        if (Config.venus) {
            venusStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "venusStoneBlockhalfslab",
                "venus_stone");
            ...
            venusDungeonBrickStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "venusDungeonBrickStoneBlockhalfslab",
                "veuns_dungeon_brick");
            venusDungeonBrickStoneBlockDoubleSlab = new BlockBasicSlab(
                true,
                null,
                "mercuryDungeonBrickStoneBlockfullslab",
                "veuns_dungeon_brick");
            venusDungeonBrickStoneStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.veunsDungeonBrick,
                0,
                "venusDungeonBrickStoneStairs");
        }
        if (Config.ceres) {
            ceresStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "ceresStoneBlockhalfslab",
                "ceres_stone");
        ...
        if (Config.jupiter) {
            jupiterStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "jupiterStoneBlockhalfslab",
                "jupiter_stone");
            ...
            jupiterStoneBrickStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.jupiterBlocks,
                9,
                "jupiterStoneBrickStairs");

            jupiterDungeonBrickStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "jupiterDungeonBrickStoneBlockhalfslab",
                "jupiter_dungeon_brick");
            jupiterDungeonBrickStoneBlockDoubleSlab = new BlockBasicSlab(
                true,
                null,
                "jupiterDungeonBrickStoneBlockfullslab",
                "jupiter_dungeon_brick");
            jupiterDungeonBrickStoneStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.jupiterDungeonBrick,
                0,
                "jupiterDungeonBrickStoneStairs");
        }
        if (Config.saturn) {
            saturnStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "saturnStoneBlockhalfslab",
                "saturn_stone");
            ...
            saturnStoneBrickStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.saturnBlocks,
                8,
                "saturnStoneBrickStairs");

            saturnDungeonBrickStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "saturnDungeonBrickStoneBlockhalfslab",
                "saturn_dungeon_brick");
            saturnDungeonBrickStoneBlockDoubleSlab = new BlockBasicSlab(
                true,
                null,
                "saturnDungeonBrickStoneBlockfullslab",
                "saturn_dungeon_brick");
            saturnDungeonBrickStoneStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.saturnDungeonBrick,
                0,
                "saturnDungeonBrickStoneStairs");
        }
        if (Config.uranus) {
            uranusStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "uranusStoneBlockhalfslab",
                "uranus_stone");
            ...
            uranusStoneBrickStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.uranusBlocks,
                5,
                "uranusStoneBrickStairs");

            uranusDungeonBrickStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "uranusDungeonBrickStoneBlockhalfslab",
                "uranus_dungeon_brick");
            uranusDungeonBrickStoneBlockDoubleSlab = new BlockBasicSlab(
                true,
                null,
                "uranusDungeonBrickStoneBlockfullslab",
                "uranus_dungeon_brick");
            uranusDungeonBrickStoneStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.uranusDungeonBrick,
                0,
                "uranusDungeonBrickStoneStairs");
        }
        if (Config.neptune) {
            neptuneStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "neptuneStoneBlockhalfslab",
                "neptune_stone");
            ...
            neptuneStoneBrickStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.neptuneBlocks,
                8,
                "neptuneStoneBrickStairs");

            neptuneDungeonBrickStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "neptuneDungeonBrickStoneBlockhalfslab",
                "neptune_dungeon_brick");
            neptuneDungeonBrickStoneBlockDoubleSlab = new BlockBasicSlab(
                true,
                null,
                "neptuneDungeonBrickStoneBlockfullslab",
                "neptune_dungeon_brick");
            neptuneDungeonBrickStoneStairs = new BlockBasicStairs(
                ExtraPlanets_Blocks.neptuneDungeonBrick,
                0,
                "neptuneDungeonBrickStoneStairs");
        }
        if (Config.pluto) {
            plutoStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "plutoStoneBlockhalfslab",
                "pluto_stone");
        ...
        if (Config.eris) {
            erisStoneBlockHalfSlab = new BlockBasicSlab(
                false,
                ExtraPlanets.BlocksTab,
                "erisStoneBlockhalfslab",
                "eris_stone");
    ...
    private static void registerSlabsAndStairs() {
        ...
        if (Config.venus) {
            ...
            GameRegistry.registerBlock(
                venusDungeonBrickStoneBlockHalfSlab,
                VenusDungeonBrickStoneItemSlab.class,
                "venusDungeonBrickStonehalfslab");
            GameRegistry.registerBlock(
                venusDungeonBrickStoneBlockDoubleSlab,
                VenusDungeonBrickStoneItemSlab.class,
        ...
        if (Config.jupiter) {
            ...
            GameRegistry.registerBlock(
                jupiterDungeonBrickStoneBlockHalfSlab,
                JupiterDungeonBrickStoneItemSlab.class,
                "jupiterDungeonBrickStonehalfslab");
            GameRegistry.registerBlock(
                jupiterDungeonBrickStoneBlockDoubleSlab,
                JupiterDungeonBrickStoneItemSlab.class,
        ...
        if (Config.saturn) {
            ...
            GameRegistry.registerBlock(
                saturnDungeonBrickStoneBlockHalfSlab,
                SaturnDungeonBrickStoneItemSlab.class,
                "saturnDungeonBrickStonehalfslab");
            GameRegistry.registerBlock(
                saturnDungeonBrickStoneBlockDoubleSlab,
                SaturnDungeonBrickStoneItemSlab.class,
        ...
        if (Config.uranus) {
            ...
            GameRegistry.registerBlock(
                uranusDungeonBrickStoneBlockHalfSlab,
                UranusDungeonBrickStoneItemSlab.class,
                "uranusDungeonBrickStonehalfslab");
            GameRegistry.registerBlock(
                uranusDungeonBrickStoneBlockDoubleSlab,
                UranusDungeonBrickStoneItemSlab.class,
        ...
        if (Config.neptune) {
            ...
            GameRegistry.registerBlock(
                neptuneDungeonBrickStoneBlockHalfSlab,
                NeptuneDungeonBrickStoneItemSlab.class,
                "neptuneDungeonBrickStonehalfslab");
            GameRegistry.registerBlock(
                neptuneDungeonBrickStoneBlockDoubleSlab,
                NeptuneDungeonBrickStoneItemSlab.class,
