...
public class ExtraPlanets_Blocks {
    ...
    public static void init() {
        ...
        registerTileEntitys();
        setHarvestLevels();
        if (Config.oreDictionary) OreDictionaryRegister();
    ...
    private static void initializeBlocks() {
        ...
        if (Config.venus) {
            ...
            ashBlock = new BlockBasic(Material.rock).setBlockName("ash_rock")
                .setHardness(2.0F)
                .setResistance(1.5F)
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "ash_rock");
            volcanicRock = new BlockBasic(Material.rock).setBlockName("volcanic_rock")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "volcanic_rock")
                .setHardness(3.0F)
                .setResistance(6.0F)
        ...
        if (Config.jupiter) {
            ...
            orangeSandstone = new BlockBasic(Material.rock).setBlockName("orange_sandstone")
                .setHardness(2F)
                .setResistance(2F)
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "orange_sandstone");
        }
        if (Config.saturn) {
        ...
        if (Config.uranus) {
            ...
            denseIce = new BlockBasic(Material.ice).setBlockName("dense_ice")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "dense_ice")
                .setHardness(2.2F)
                .setResistance(3.0F)
        ...
        if (Config.neptune) {
            ...
            frozenNitrogen = new BlockBasic(Material.ice).setBlockName("frozen_nitrogen")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "frozen_nitrogen")
                .setStepSound(Block.soundTypeSnow);
        }
        if (Config.pluto) {
        ...
        if (Config.mercury || Config.ceres || Config.pluto || Config.eris)
            fossil = new BlockFossil(Material.rock).setBlockName("fossil")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "fossil")
                .setHardness(2.5F)
                .setResistance(1.0F);
        if (Config.ceres && Config.nuclearBomb) nuclearBomb = new BlockNuclearBomb();
        if (Config.saturn && Config.fireBomb) fireBomb = new BlockFireBomb();
        if (Config.kepler22b && Config.keplerSolarSystems) {
            ...
            redSandstone = new BlockBasic(Material.rock).setBlockName("red_sandstone")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "red_sandstone")
                .setHardness(2F)
                .setResistance(2F);
        }
        ...
        diamondGrit = new BlockCustomGravel("diamond_grit").setCreativeTab(ExtraPlanets.BlocksTab)
            .setLightLevel(0.5F);
        goldGrit = new BlockCustomGravel("gold_grit").setCreativeTab(ExtraPlanets.BlocksTab)
            .setLightLevel(0.5F);
        ironGrit = new BlockCustomGravel("iron_grit").setCreativeTab(ExtraPlanets.BlocksTab)
            .setLightLevel(0.5F);
        coalGrit = new BlockCustomGravel("coal_grit").setCreativeTab(ExtraPlanets.BlocksTab)
            .setLightLevel(0.5F);
        emeraldGrit = new BlockCustomGravel("emerald_grit").setCreativeTab(ExtraPlanets.BlocksTab)
            .setLightLevel(0.5F);
    }

    private static void initializeDungeonBlocks() {
        if (Config.venus) {
            veunsDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("veuns.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "veuns_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
        ...
        if (Config.jupiter) {
            jupiterDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("jupiter.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "jupiter_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
        ...
        if (Config.saturn) {
            saturnDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("saturn.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "saturn_dungeon_brick")
                .setHardness(4.0f)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
        ...
        if (Config.uranus) {
            uranusDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("uranus.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "uranus_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
        ...
        if (Config.neptune) {
            neptuneDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("neptune.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "neptune_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
        ...
        if (Config.pluto) {
            plutoDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("pluto.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "pluto_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
        ...
        if (Config.eris) {
            erisDungeonBrick = new BlockDungeonBrick(Material.rock).setBlockName("eris.dungeon_brick")
                .setBlockTextureName(Constants.TEXTURE_PREFIX + "eris_dungeon_brick")
                .setHardness(4.0F)
                .setResistance(40.0F)
                .setStepSound(Block.soundTypeMetal);
    ...
    private static void initializeTreasureChestBlocks() {
        ...
        if (Config.saturn) {
            ...
            else treasureChestTier6 = new T6TreasureChest("treasure_chest_t6");
        }
        if (Config.uranus) {
            if (Config.morePlanetsCompatibilityAdv143)
                treasureChestTier7 = new T7TreasureChest("treasure_chest_t4_uranus");
            else treasureChestTier7 = new T7TreasureChest("treasure_chest_t7");
        }
        if (Config.neptune) {
            if (Config.morePlanetsCompatibilityAdv143)
                treasureChestTier8 = new T8TreasureChest("treasure_chest_t5_neptune");
            else treasureChestTier8 = new T8TreasureChest("treasure_chest_t8");
        }
        if (Config.pluto) {
        ...
        if (Config.eris) {
            ...
            else treasureChestTier10 = new T10TreasureChest("treasure_chest_t10");
        }
    }
    ...
    private static void registerBlocks() {
        ...
        if (Config.kepler22b && Config.keplerSolarSystems) {
            ...
            GameRegistry
                .registerBlock(kepler22bGrassFlowers, ItemBlockKepler22bTallGrass.class, "tile.kepler22bFlowers");
        ...
        if (Config.oberon) {
            GameRegistry.registerBlock(
                oberonBlocks,
                ItemBlockOberon.class,
                oberonBlocks.getUnlocalizedName()
                    .substring(5));
        ...
        if (Config.titania) {
            GameRegistry.registerBlock(
                titaniaBlocks,
                ItemBlockTitania.class,
                titaniaBlocks.getUnlocalizedName()
                    .substring(5));
        ...
        if (Config.iapetus) {
            GameRegistry.registerBlock(
                iapetusBlocks,
                ItemBlockIapetus.class,
                iapetusBlocks.getUnlocalizedName()
                    .substring(5));
            GameRegistry.registerBlock(iapetusGravel, "iapetusGravel");
        }
        if (Config.mercury || Config.ceres || Config.pluto || Config.eris) GameRegistry.registerBlock(fossil, "fossil");
        if (Config.ceres && Config.nuclearBomb) GameRegistry.registerBlock(nuclearBomb, "nuclearBomb");
        if (Config.saturn && Config.fireBomb) GameRegistry.registerBlock(fireBomb, "fireBomb");
    ...
    private static void registerTileEntitys() {
        if (Config.venus) {
            GameRegistry
                .registerTileEntity(TileEntityDungeonSpawnerVenus.class, Constants.modName + "Veuns Dungeon Spawner");
            GameRegistry
                .registerTileEntity(TileEntityT4TreasureChest.class, Constants.modName + "Tier 4 Treasure Chest");
        }
        if (Config.jupiter) {
            GameRegistry.registerTileEntity(
                TileEntityDungeonSpawnerJupiter.class,
                Constants.modName + "Juptier Dungeon Spawner");
            GameRegistry
                .registerTileEntity(TileEntityT5TreasureChest.class, Constants.modName + "Tier 5 Treasure Chest");
        }
        if (Config.saturn) {
            GameRegistry
                .registerTileEntity(TileEntityDungeonSpawnerSaturn.class, Constants.modName + "Saturn Dungeon Spawner");

            if (Config.morePlanetsCompatibilityAdv143) GameRegistry.registerTileEntity(
                TileEntityT6TreasureChest.class,
                Constants.modName + "Tier 4 Saturn Treasure Chest");
            else GameRegistry
                .registerTileEntity(TileEntityT6TreasureChest.class, Constants.modName + "Tier 6 Treasure Chest");
        }
        if (Config.uranus) {
            GameRegistry
                .registerTileEntity(TileEntityDungeonSpawnerUranus.class, Constants.modName + "Uranus Dungeon Spawner");

            if (Config.morePlanetsCompatibilityAdv143) GameRegistry.registerTileEntity(
                TileEntityT7TreasureChest.class,
                Constants.modName + "Tier 4 Uranus Treasure Chest");
            else GameRegistry
                .registerTileEntity(TileEntityT7TreasureChest.class, Constants.modName + "Tier 7 Treasure Chest");
        }
        if (Config.neptune) {
            GameRegistry.registerTileEntity(
                TileEntityDungeonSpawnerNeptune.class,
                Constants.modName + "Neptune Dungeon Spawner");

            if (Config.morePlanetsCompatibilityAdv143) GameRegistry.registerTileEntity(
                TileEntityT8TreasureChest.class,
                Constants.modName + "Tier 5 Neptune Treasure Chest");
            else GameRegistry
                .registerTileEntity(TileEntityT8TreasureChest.class, Constants.modName + "Tier 8 Treasure Chest");
        }
        if (Config.pluto) {
            GameRegistry
                .registerTileEntity(TileEntityDungeonSpawnerPluto.class, Constants.modName + "Pluto Dungeon Spawner");
            GameRegistry
                .registerTileEntity(TileEntityT9TreasureChest.class, Constants.modName + "Tier 9 Treasure Chest");
        }
        if (Config.eris) {
            GameRegistry
                .registerTileEntity(TileEntityDungeonSpawnerEris.class, Constants.modName + "Eris Dungeon Spawner");
            if (Config.morePlanetsCompatibilityAdv143) GameRegistry
                .registerTileEntity(TileEntityT10TreasureChest.class, Constants.modName + "Tier 6 Eris Treasure Chest");
            else GameRegistry
                .registerTileEntity(TileEntityT10TreasureChest.class, Constants.modName + "Tier 10 Treasure Chest");
        }
    ...
    private static void registerTreeBlocks() {
        ...
        GameRegistry
            .registerBlock(kepler22bMapleSapling, ItemBlockKepler22bMapleSapling.class, "tile.kepler22bMapleSaplings");
        GameRegistry
            .registerBlock(kepler22bMapleLeaf, ItemBlockKepler22bMapleLeaf.class, "tile.kepler22bNewMapleLeaves");
        GameRegistry
            .registerBlock(kepler22bMapleLeaf2, ItemBlockKepler22bMapleLeaf2.class, "tile.kepler22bNewMapleLeaves2");
