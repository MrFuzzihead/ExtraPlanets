...
public class BlockBasicGrass extends Block {
        ...
        if (!world.isRemote) {
            if (world.getBlockLightValue(x, y + 1, z) < 4 && world.getBlockLightOpacity(x, y + 1, z) > 2) {
                ...
                for (int l = 0; l < 4; ++l) {
                    ...
                    if (world.getBlock(i1, j1, k1) == ExtraPlanets_Blocks.kepler22bBlocks
    ...
    public boolean canSustainPlant(IBlockAccess world, int x, int y, int z, ForgeDirection direction,
        ...
        return (plant == ExtraPlanets_Blocks.kepler22bMapleSapling
            || plant == ExtraPlanets_Blocks.kepler22bGrassFlowers);
    }
}
