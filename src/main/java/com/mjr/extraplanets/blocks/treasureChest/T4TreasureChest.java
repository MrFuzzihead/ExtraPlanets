    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer,
        ...
        if (var10 == null) {
            ...
            && (par1World.isSideSolid(par2 - 1, par3 + 1, par4, ForgeDirection.DOWN)
                || T4TreasureChest.isOcelotBlockingChest(par1World, par2 - 1, par3, par4))) {
                    return true;
                } else
            if (par1World.getBlock(par2 + 1, par3, par4) == this
                && (par1World.isSideSolid(par2 + 1, par3 + 1, par4, ForgeDirection.DOWN)
                ...
                if (par1World.getBlock(par2, par3, par4 - 1) == this
                    && (par1World.isSideSolid(par2, par3 + 1, par4 - 1, ForgeDirection.DOWN)
                        || T4TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 - 1))) {
                            return true;
                        } else
                    if (par1World.getBlock(par2, par3, par4 + 1) == this
                        && (par1World.isSideSolid(par2, par3 + 1, par4 + 1, ForgeDirection.DOWN)
                            || T4TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 + 1))) {
                                ...
                                if (par1World.getBlock(par2 - 1, par3, par4) == this) {
                                    var10 = new InventoryLargeChest(
                                        ...
                                        (TileEntityT4TreasureChest) par1World.getTileEntity(par2 - 1, par3, par4),
                                        (IInventory) var10);
                                }
                                ...
                                if (par1World.getBlock(par2, par3, par4 - 1) == this) {
                                    var10 = new InventoryLargeChest(
                                        "container.chestDouble",
                                        (TileEntityT4TreasureChest) par1World.getTileEntity(par2, par3, par4 - 1),
                                        (IInventory) var10);
                                }
