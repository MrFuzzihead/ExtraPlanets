...
public class BlockDecorativeBlocks2 extends Block {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        ...
        this.blockIcons[2] = par1IconRegister
            .registerIcon(Constants.TEXTURE_PREFIX + "decorative_blocks_2_" + "blue_block");
        this.blockIcons[3] = par1IconRegister
            .registerIcon(Constants.TEXTURE_PREFIX + "decorative_blocks_2_" + "light_blue_block");
        this.blockIcons[4] = par1IconRegister
            .registerIcon(Constants.TEXTURE_PREFIX + "decorative_blocks_2_" + "yellow_block");
        this.blockIcons[5] = par1IconRegister
            .registerIcon(Constants.TEXTURE_PREFIX + "decorative_blocks_2_" + "green_block");
