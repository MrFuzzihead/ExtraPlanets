...
public class BlockKepler22bMapleTreeSapling extends BlockFlower {
    ...
    private final static String[] saplings = { "blue_maple", "red_maple", "purple_maple", "yellow_maple", "green_maple",
        "brown_maple" };
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < saplings.length; i++) {
            this.saplingsTextures[i] = iconRegister
                .registerIcon(Constants.TEXTURE_PREFIX + name + "_sapling_" + saplings[i]);
        }
    }
    ...
    public void markOrGrowMarked(World world, int x, int y, int z, Random random) {
        ...
        if (object == null) {
            switch (meta) {
                case 0:
                    object = new WorldGenKepler22bTree(
                        false,
                        8,
                        0,
                        0,
