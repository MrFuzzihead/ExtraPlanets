...
public class BlockKepler22bMapleTreeLeaves extends BlockLeavesBase implements IShearable {
    ...
    public void registerBlockIcons(IIconRegister iconReg) {
        ...
        for (int i = 0; i < leaves.length; ++i) {
            this.leafTextures[0][i] = iconReg
                .registerIcon(Constants.TEXTURE_PREFIX + name.replace("_new", "") + "_leaves_" + leaves[i]);
            this.leafTextures[1][i] = iconReg
                .registerIcon(Constants.TEXTURE_PREFIX + name.replace("_new", "") + "_leaves_" + leaves[i]);
        }
    }
    ...
    public IIcon getIcon(int side, int meta) {
        ...
        return (meta & 3) == 1 ? this.leafTextures[this.field_150127_b][1]
            : ((meta & 3) == 3 ? this.leafTextures[this.field_150127_b][3]
                : ((meta & 3) == 2 ? this.leafTextures[this.field_150127_b][2]
