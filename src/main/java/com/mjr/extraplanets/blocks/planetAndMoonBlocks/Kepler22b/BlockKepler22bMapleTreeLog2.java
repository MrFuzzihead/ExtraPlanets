...
public class BlockKepler22bMapleTreeLog2 extends BlockRotatedPillar {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < logs.length; i++) {
            this.logsTextures[i] = iconRegister
                .registerIcon(Constants.TEXTURE_PREFIX + name + "_log_" + logs[i] + "_side");
            this.logsTexturesTop[i] = iconRegister
                .registerIcon(Constants.TEXTURE_PREFIX + name + "_log_" + logs[i] + "_top");
        }
    }
