...
public class ExtraPlanets_Machines {
    ...
    private static void initializeMachinesBlocks() {
        if (Config.advancedRefinery) advancedRefinery = new AdvancedRefinery("advanced_refinery");
        if (Config.ultimateRefinery) ultimateRefinery = new UltimateRefinery("ultimate_refinery");
        if (Config.advancedFuelLoader) advancedFuelLoader = new AdvancedFuelLoader("advanced_fuel_loader");
        if (Config.ultimateFuelLoader) ultimateFuelLoader = new UltimateFuelLoader("ultimate_fuel_loader");
        ...
        if (Config.solarPanels) solarPanel = new BlockSolar("solar");
        if (Config.chargingBlock) chargingBlock = new VehicleCharger("vehicle_charger");
    }

    private static void registerMachines() {
        if (Config.advancedRefinery) GameRegistry.registerBlock(advancedRefinery, "advancedRefinery");
        if (Config.ultimateRefinery) GameRegistry.registerBlock(ultimateRefinery, "ultimateRefinery");
        if (Config.advancedFuelLoader) GameRegistry.registerBlock(advancedFuelLoader, "advancedFuelLoader");
        if (Config.ultimateFuelLoader) GameRegistry.registerBlock(ultimateFuelLoader, "ultimateFuelLoader");
        if (Config.advancedOxygenCompressor) GameRegistry.registerBlock(
            advancedOxygenCompressor,
            ItemBlockAdvancedOxygenCompressor.class,
            "advancedOxygenCompressor");
        if (Config.ultimateOxygenCompressor) GameRegistry.registerBlock(
            ultimateOxygenCompressor,
            ItemBlockUltimateOxygenCompressor.class,
            "ultimateOxygenCompressor");
        ...
        if (Config.chargingBlock) GameRegistry.registerBlock(chargingBlock, "chargingBlock");
    }
    ...
    private static void registerMachineTileEntitys() {
        ...
        if (Config.advancedFuelLoader) GameRegistry
            .registerTileEntity(TileEntityAdvancedFuelLoader.class, Constants.modName + "AdvancedFuelLoader");
        if (Config.ultimateFuelLoader) GameRegistry
            .registerTileEntity(TileEntityUltimateFuelLoader.class, Constants.modName + "UltimateFuelLoader");
        if (Config.advancedOxygenCompressor) {
            GameRegistry.registerTileEntity(
                TileEntityAdvancedOxygenCompressor.class,
                Constants.modName + "AdvancedOxygenCompressor");
            GameRegistry.registerTileEntity(
                TileEntityAdvancedOxygenDecompressor.class,
                Constants.modName + "AdvancedOxygenDecompressor");
        }
        if (Config.ultimateOxygenCompressor) {
            GameRegistry.registerTileEntity(
                TileEntityUltimateOxygenCompressor.class,
                Constants.modName + "UltimateOxygenCompressor");
            GameRegistry.registerTileEntity(
                TileEntityUltimateOxygenDecompressor.class,
                Constants.modName + "UltimateOxygenDecompressor");
        }
        if (Config.solarPanels)
