...
public class ItemTier11Items extends Item {
    ...
    public static final String[] names = { "blue_diamond", "red_diamond", "purple_diamond", "yellow_diamond",
        "green_diamond", "blue_sticks", "red_sticks", "purple_sticks", "yellow_sticks", "green_sticks", "brown_sticks",
        "ingot_platinum", "compressed_platinum" };
