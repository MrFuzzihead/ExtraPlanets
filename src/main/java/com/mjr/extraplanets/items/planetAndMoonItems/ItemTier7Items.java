...
public class ItemTier7Items extends Item {
    ...
    public static final String[] names = { "tier7engine", "tier7booster", "tier7fin", "tier7heavy_duty_plate",
        "compressed_crystal", "ingot_crystal", "compressed_reinforced_crystal", "white_gem" };
