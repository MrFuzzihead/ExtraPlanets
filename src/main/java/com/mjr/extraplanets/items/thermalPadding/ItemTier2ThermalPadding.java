...
public class ItemTier2ThermalPadding extends Item implements IItemThermal {
    ...
    public static String[] names = { "tier2_thermal_helm", "tier2_thermal_chestplate", "tier2_thermal_leggings",
        "tier2_thermal_boots", "tier2_thermal_helm0", "tier2_thermal_chestplate0", "tier2_thermal_leggings0",
        "tier2_thermal_boots0" };
