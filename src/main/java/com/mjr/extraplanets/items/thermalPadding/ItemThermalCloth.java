...
public class ItemThermalCloth extends Item {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for (final String name : ItemThermalCloth.names) {
            String temp = name;
            if (temp.contains("tier2")) temp = temp.replace("tier2", "tier3");
            else if (temp.contains("tier3")) temp = temp.replace("tier3", "tier4");
            else if (temp.contains("tier4")) temp = temp.replace("tier4", "tier5");
