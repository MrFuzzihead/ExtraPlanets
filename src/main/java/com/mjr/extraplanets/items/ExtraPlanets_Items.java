...
public class ExtraPlanets_Items {
    ...
    private static void initializeItems() {
        ...
        if (Config.jupiter) {
            if (Config.batteries) nickelBattery = new ItemBasicBattery("nickel_battery", 45000f, 2);
        ...
        if (Config.neptune) {
            if (Config.batteries) zincBattery = new ItemBasicBattery("zinc_battery", 125000f, 2);
            if (Config.morePlanetsCompatibilityAdv143 == false) {
        ...
        if (Config.cannedFood) cannedFood = new ItemCannedFood("canned_food");
        ...
        if (Config.marsRover) marsRover = new ItemMarsRover("mars_rover");
        if (Config.venusRover) venusRover = new ItemVenusRover("venus_rover");
        if (Config.marsRover || Config.venusRover) electricParts = new ItemElectricParts("electric_parts");
        if (Config.marsRover) schematicMarsRover = new SchematicMarsRover("schematic_mars_rover");
        if (Config.venusRover) schematicVenusRover = new SchematicVenusRover("schematic_venus_rover");
        ...
        liquid_hydrocarbon_bucket = new ItemBasicItemBucket(
            "bucket_liquid_hydrocarbon",
            ExtraPlanets_Fluids.liquid_hydrocarbon);
        liquid_chocolate_bucket = new ItemBasicItemBucket(
            "bucket_liquid_chocolate",
            ExtraPlanets_Fluids.liquid_chocolate);
        liquid_caramel_bucket = new ItemBasicItemBucket("bucket_liquid_caramel", ExtraPlanets_Fluids.liquid_caramel);
    }

    private static void registerItems() {
        if (Config.mercury) {
            if (Config.batteries) GameRegistry.registerItem(mercuryBattery, "mercuryBattery");
        ...
        if (Config.jupiter) {
            ...
            if (Config.batteries) GameRegistry.registerItem(nickelBattery, "nickelBattery");
        }
        if (Config.saturn) {
            if (Config.morePlanetsCompatibilityAdv143 == false) {
        ...
        if (Config.neptune) {
            ...
            if (Config.batteries) GameRegistry.registerItem(zincBattery, "zincBattery");
        }
        if (Config.pluto) {
        ...
        if (Config.cannedFood) GameRegistry.registerItem(cannedFood, "cannedFood");
        if (Config.customApples) {
    ...
    private static void registerFluidContainer() {
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.glowstone_fluid,
            new ItemStack(glowstone_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.magma_fluid,
            new ItemStack(magma_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.nitrogen_fluid,
            new ItemStack(nitrogen_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.frozen_water_fluid,
            new ItemStack(frozen_water_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.salt_fluid,
            new ItemStack(salt_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.nitrogen_ice_fluid,
            new ItemStack(nitrogen_ice_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.methane_fluid,
            new ItemStack(methane_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.infected_water_fluid,
            new ItemStack(infected_water_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.liquid_hydrocarbon_fluid,
            new ItemStack(liquid_hydrocarbon_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.liquid_chocolate_fluid,
            new ItemStack(liquid_chocolate_bucket, 1, 0),
            new ItemStack(Items.bucket));
        FluidContainerRegistry.registerFluidContainer(
            ExtraPlanets_Fluids.liquid_caramel_fluid,
            new ItemStack(liquid_caramel_bucket, 1, 0),
            new ItemStack(Items.bucket));
    }
