...
public class NeptuneDungeonBrickStoneItemSlab extends ItemSlab {
    ...
    public NeptuneDungeonBrickStoneItemSlab(Block block) {
        super(
            block,
            ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.neptuneDungeonBrickStoneBlockHalfSlab)),
            ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.neptuneDungeonBrickStoneBlockDoubleSlab)),
            false);
        this.setMaxDamage(0);
