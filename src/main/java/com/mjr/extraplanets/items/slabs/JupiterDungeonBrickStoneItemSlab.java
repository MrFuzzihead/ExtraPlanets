...
public class JupiterDungeonBrickStoneItemSlab extends ItemSlab {
    ...
    public JupiterDungeonBrickStoneItemSlab(Block block) {
        super(
            block,
            ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.jupiterDungeonBrickStoneBlockHalfSlab)),
            ((BlockSlab) (ExtraPlanets_SlabsStairsBlocks.jupiterDungeonBrickStoneBlockDoubleSlab)),
            false);
        this.setMaxDamage(0);
