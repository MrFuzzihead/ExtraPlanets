...
public class Constants {
    ...
    public static final String modVersion = "1.7.10" + "-"
        + LOCALMAJVERSION
        + "."
        + LOCALMINVERSION
        + "."
    ...
    public static final String DEPENDENCIES_FORGE = "required-after:Forge@[10.13.4.1558,); "; // Keep the space at the
                                                                                              // end!
    public static final String DEPENDENCIES_MODS = "required-after:GalacticraftCore;required-after:GalacticraftMars; "; // Keep
                                                                                                                        // the
                                                                                                                        // space
                                                                                                                        // at
                                                                                                                        // the
