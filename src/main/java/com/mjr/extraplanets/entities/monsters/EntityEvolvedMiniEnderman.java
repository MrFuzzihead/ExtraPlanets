...
public class EntityEvolvedMiniEnderman extends EntityMob implements IEntityBreathable {
    ...
    private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
        ...
        if (itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
            ...
            Vec3 vec31 = Vec3.createVectorHelper(
                ...
                this.boundingBox.minY + this.height / 2.0F - (p_70821_1_.posY + p_70821_1_.getEyeHeight()),
    ...
    protected boolean teleportToEntity(Entity p_70816_1_) {
        Vec3 vec3 = Vec3.createVectorHelper(
            ...
            this.boundingBox.minY + this.height / 2.0F - p_70816_1_.posY + p_70816_1_.getEyeHeight(),
