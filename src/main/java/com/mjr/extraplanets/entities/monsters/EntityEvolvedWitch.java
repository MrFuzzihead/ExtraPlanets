...
public class EntityEvolvedWitch extends EntityMob implements IRangedAttackMob, IEntityBreathable {
    ...
    protected void entityInit() {
        super.entityInit();
        this.getDataWatcher()
            .addObject(21, Byte.valueOf((byte) 0));
    }
    ...
    public void setAggressive(boolean p_82197_1_) {
        this.getDataWatcher()
            .updateObject(21, Byte.valueOf((byte) (p_82197_1_ ? 1 : 0)));
    }
            ...
            if (this.getAggressive()) {
                ...
                if (this.rand.nextFloat() < 0.15F && this.isInsideOfMaterial(Material.water)
                    ...
                    && !this.isPotionActive(Potion.fireResistance)) {
                        ...
                        if (this.rand.nextFloat() < 0.25F && this.getAttackTarget() != null
                            && !this.isPotionActive(Potion.moveSpeed)
                            && this.getAttackTarget()
                                .getDistanceSqToEntity(this) > 121.0D) {
                                    short1 = 16274;
