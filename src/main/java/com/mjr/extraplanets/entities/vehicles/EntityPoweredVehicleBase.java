...
public abstract class EntityPoweredVehicleBase extends Entity
    implements IInventory, IPacketReceiver, IPoweredDockable, IControllableEntity, IEntityFullSync {
    ...
    public void updateRiderPosition() {
        if (this.riddenByEntity != null) {
            ...
            this.riddenByEntity.setPosition(
                this.posX + var1,
                (this.posY - 2.4 + this.riddenByEntity.getYOffset()) + 0.6,
                this.posZ + var3);
        }
    }
    ...
    public boolean pressKey(int key) {
        ...
        switch (key) {
            case 0: // Deccelerate
                if (this.currentPowerCapacity < 10) return false;
    ...
    public float addPower(float amount, boolean doDrain) {
        ...
        else this.setCurrentPowerCapacity(this.getCurrentPowerCapacity() + amount);
    ...
    public float removePower(float amount) {
        float beforePower = this.getCurrentPowerCapacity();
        if ((this.getCurrentPowerCapacity() - amount) <= 0) this.setCurrentPowerCapacity(0);
        else this.setCurrentPowerCapacity(this.getCurrentPowerCapacity() - amount);
