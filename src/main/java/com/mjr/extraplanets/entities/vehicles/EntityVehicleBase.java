...
public abstract class EntityVehicleBase extends Entity
    ...
    public void updateRiderPosition() {
        if (this.riddenByEntity != null) {
            ...
            this.riddenByEntity.setPosition(
                this.posX + var1,
                (this.posY - 2.5 + this.riddenByEntity.getYOffset()) + 0.4,
                this.posZ + var3);
        }
    }
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote && this.roverFuelTank.getFluid() != null
            && this.roverFuelTank.getFluid().amount > 0) {
    ...
    public int addFuel(FluidStack liquid, boolean doDrain) {
        if (this.landingPad != null) return FluidUtil.fillWithGCFuel(this.roverFuelTank, liquid, doDrain);
