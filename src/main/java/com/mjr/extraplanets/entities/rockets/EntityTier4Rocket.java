...
public class EntityTier4Rocket extends EntityTieredRocket {
    ...
    public void onLaunch() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            PADSEARCH: for (int x = MathHelper.floor_double(this.posX) - 3; x
                <= MathHelper.floor_double(this.posX) + 3; x++) {
                for (int y = MathHelper.floor_double(this.posY) - 3; y <= MathHelper.floor_double(this.posY) + 1; y++) {
                    for (int z = MathHelper.floor_double(this.posZ) - 3; z
                        <= MathHelper.floor_double(this.posZ) + 3; z++) {
