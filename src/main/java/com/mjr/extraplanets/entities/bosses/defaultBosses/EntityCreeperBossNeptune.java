...
public class EntityCreeperBossNeptune extends EntityMob
    ...
    public ItemStack getGuaranteedLoot(Random rand) {
        ...
        if (Config.morePlanetsCompatibilityAdv143) stackList = GalacticraftRegistry.getDungeonLoot(4);
        else stackList = GalacticraftRegistry.getDungeonLoot(8);
    ...
    private void func_82209_a(int par1, double par2, double par4, double par6) {
        ...
        double d7 = par4 - d4;
        double d8 = par6 - d5;
        EntityProjectileTNT entitywitherskull = new EntityProjectileTNT(
            this.worldObj,
            this,
            d6 * 0.5D,
            d7 * 0.5D,
