...
public class EntityFireBombPrimed extends Entity {
    ...
    public EntityFireBombPrimed(World p_i1730_1_, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_,
    ...
    private void explode() {
        ...
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 15; j++) {
                if (this.rand.nextInt(3) == 1) this.worldObj.setBlock(
                    (int) this.posX + i,
                    this.worldObj.getHeightValue((int) this.posX + i, (int) this.posZ + j),
                    (int) this.posZ + j,
                    Blocks.fire);
            }
        }
