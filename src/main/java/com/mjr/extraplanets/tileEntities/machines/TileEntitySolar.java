...
public class TileEntitySolar extends TileBaseUniversalElectricalSource
            ...
            if (!this.getDisabled(0) && this.ticks % 20 == 0) {
                ...
                if (this.worldObj.provider instanceof IGalacticraftWorldProvider
                    ...
                    if (this.worldObj.isDaytime()) {
                            ...
                            for (int z = -1; z <= 1; z++) {
                                if (this.tierGC == 1) {
                                    ...
                                    for (double d = 0.0D; d < distance; d++) {
                                        BlockVec3 blockAt = blockVec.clone()
                        ...
                        if (this.tierGC == 2) this.solarStrength = this.solarStrength * 2;
    ...
    public int getGenerate() {
        ...
        int sum = MathHelper.floor_float(
            0.01F * difference
                * difference
                    ...
                    if (this.worldObj.isRemote && this.worldObj.rand.nextDouble() < 0.1D) {
                        FMLClientHandler.instance()
                            .getClient().effectRenderer.addBlockDestroyEffects(
                                ...
                                thisBlock.y + y,
                                thisBlock.z + (y == 2 ? z : 0),
                                ExtraPlanets_Machines.solarPanel,
