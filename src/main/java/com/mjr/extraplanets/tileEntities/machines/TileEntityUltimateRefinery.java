...
public class TileEntityUltimateRefinery extends TileBaseElectricBlockWithInventory
    ...
    public void smeltItem() {
        if (this.canProcess()) {
            ...
            final int amountToDrain = Math
                .min(Math.min(oilAmount, fuelSpace), TileEntityUltimateRefinery.OUTPUT_PER_SECOND);
