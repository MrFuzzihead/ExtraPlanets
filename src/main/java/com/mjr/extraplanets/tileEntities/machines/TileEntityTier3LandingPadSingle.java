    ...
    public void updateEntity() {
        if (!this.worldObj.isRemote) {
            ...
            if (attachedLaunchPads.size() == 25) {
                ...
                this.worldObj
                    .setBlock(this.xCoord, this.yCoord, this.zCoord, ExtraPlanets_Blocks.advancedLaunchPadFull, 1, 3);
                final TileEntityTier3LandingPad tilePadFull = (TileEntityTier3LandingPad) this.worldObj
