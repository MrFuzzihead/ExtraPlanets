...
public class AchievementEventHandler {
    ...
    public void onCraftingRockets(EntityItemPickupEvent event) {
        if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier4Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_4, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier5Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_5, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier6Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_6, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier7Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_7, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier8Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_8, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier9Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_9, 1);
        else if (event.item.getEntityItem()
            .getItem() == ExtraPlanets_Items.tier10Rocket)
            event.entityPlayer.addStat(ExtraPlanets_Achievements.craft_rocket_10, 1);
    }

    @SubscribeEvent
    public void onDimensionChange(PlayerChangedDimensionEvent event) {
        if (event.toDim == Config.mercuryID) event.player.addStat(ExtraPlanets_Achievements.mercury_planet, 1);
        else if (event.toDim == Config.venusID) event.player.addStat(ExtraPlanets_Achievements.venus_planet, 1);
        else if (event.toDim == Config.ceresID) event.player.addStat(ExtraPlanets_Achievements.ceres_planet, 1);
        else if (event.toDim == Config.jupiterID) event.player.addStat(ExtraPlanets_Achievements.jupiter_planet, 1);
        else if (event.toDim == Config.saturnID) event.player.addStat(ExtraPlanets_Achievements.saturn_planet, 1);
        else if (event.toDim == Config.uranusID) event.player.addStat(ExtraPlanets_Achievements.uranus_boss, 1);
        else if (event.toDim == Config.neptuneID) event.player.addStat(ExtraPlanets_Achievements.neptune_planet, 1);
        else if (event.toDim == Config.plutoID) event.player.addStat(ExtraPlanets_Achievements.pluto_planet, 1);
        else if (event.toDim == Config.erisID) event.player.addStat(ExtraPlanets_Achievements.eris_planet, 1);
    }
}
